...
public class Gui {
    ...
    public void render(GuiGraphics p_282884_, DeltaTracker p_342095_) {
        ...
        // Aporia: Custom HUD rendering
        ru.module.ModuleManager.getInstance().onTick();
        ru.ui.notify.NotifyRenderer.render(p_282884_);
        if (this.minecraft.screen == null) {
            if (org.lwjgl.glfw.GLFW.glfwGetKey(this.minecraft.getWindow().handle(), 96) == org.lwjgl.glfw.GLFW.GLFW_PRESS) {
                this.minecraft.setScreen(new ru.ui.clickgui.ClickGuiScreen(this.minecraft.getWindow().getWidth(), this.minecraft.getWindow().getHeight()));
            }
        }
    }
