...
public class ChatComponent {
    ...
    /**
     * Get the message at the given screen coordinates.
     * 
     * @param mouseX Mouse X coordinate
     * @param mouseY Mouse Y coordinate
     * @return The message content or null if no message at coordinates
     */
    public String getMessageAt(int mouseX, int mouseY) {
        ...
        /**
         * Calculate Y position relative to chat bottom
         * Chat starts at (screenHeight - 40) and goes up
         */
        ...
        if (lineIndex >= 0 && lineIndex < linesPerPage) {
            ...
            if (messageIndex >= 0 && messageIndex < this.trimmedMessages.size()) {
                ...
                /**
                 * Find the parent message for this line
                 */
    ...
    public void addMessage(Component p_241484_, @Nullable MessageSignature p_241323_, @Nullable GuiMessageTag p_241297_) {
        ...
        if (!playerName.isEmpty() && messageText.toLowerCase().contains(playerName.toLowerCase())) {
            ...
            Notify.Manager.getInstance().showNotification(
                Notify.Messages.chatMention(),
                Notify.NotificationType.MENTION
            );
        }
