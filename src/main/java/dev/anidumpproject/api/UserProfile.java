package dev.anidumpproject.api;

import dev.aporia.OsManager;
import dev.aporia.UserData;
import dev.anidumpproject.api.annotation.Native;
import dev.aporia.UserGenerator;
 ...
 * </p>
 * <ul>
 *   <li>{@link UserData - генерация пользовательских данных</li>
 *   <li>{@link UserGenerator } - генерация UUID и HWID</li>
 *   <li>{@link OsManager} - информация о системе</li>
 * </ul>
 * 
 * @author protect3ed
 * @version 2.0
...
public class UserProfile {
     ...
     *
     * бля тут короче пизда потом проверку на юзера ебану в тг/дс боте а ща сосать пока бибу
     *
