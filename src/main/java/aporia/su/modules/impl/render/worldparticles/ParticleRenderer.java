...
public class ParticleRenderer {
    ...
    private static final Identifier GLOW_TEXTURE = Identifier.of("aporia", "textures/world/dashbloom.png");
    private static final Identifier GLOW_TEXTURE_SECONDARY = Identifier.of("aporia", "textures/world/dashbloomsample.png");
