package aporia.su.modules.impl.render.worldparticles;
...
public class Particle implements IMinecraft {
    ...
    private static final Identifier TEXTURE_CROWN = Identifier.of("aporia", "textures/world/crown.png");
    private static final Identifier TEXTURE_CUBE_BLAST = Identifier.of("aporia", "textures/world/cubeblast1.png");
    private static final Identifier TEXTURE_DOLLAR = Identifier.of("aporia", "textures/world/dollar.png");
    private static final Identifier TEXTURE_HEART = Identifier.of("aporia", "textures/world/heart.png");
    private static final Identifier TEXTURE_LIGHTNING = Identifier.of("aporia", "textures/world/lightning.png");
    private static final Identifier TEXTURE_LINE = Identifier.of("aporia", "textures/world/line.png");
    private static final Identifier TEXTURE_RHOMBUS = Identifier.of("aporia", "textures/world/rhombus.png");
    private static final Identifier TEXTURE_SNOWFLAKE = Identifier.of("aporia", "textures/world/snowflake.png");
    private static final Identifier TEXTURE_STAR = Identifier.of("aporia", "textures/world/star.png");
    private static final Identifier TEXTURE_STAR_ALT = Identifier.of("aporia", "textures/world/star1.png");
    private static final Identifier TEXTURE_TRIANGLE = Identifier.of("aporia", "textures/world/triangle.png");
    private static final Identifier TEXTURE_GLOW = Identifier.of("aporia", "textures/world/dashbloom.png");

    private static final Identifier GLOW_BLOOM = Identifier.of("aporia", "textures/world/dashbloom.png");
    private static final Identifier GLOW_BLOOM_SAMPLE = Identifier.of("aporia", "textures/world/dashbloomsample.png");
