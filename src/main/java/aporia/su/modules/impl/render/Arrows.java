...
import aporia.su.util.user.render.animations.Easings;
import aporia.su.util.user.render.animations.SmoothAnimation;
...
public class Arrows extends ModuleStructure {
    ...
    private static final Identifier ARROW_TEXTURE = Identifier.of("aporia", "textures/world/arrow.png");
