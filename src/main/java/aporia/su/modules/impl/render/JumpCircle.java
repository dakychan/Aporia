...
public class JumpCircle extends ModuleStructure implements IMinecraft {
    ...
    final Identifier circleTexture = Identifier.of("aporia", "images/circle/circle.png");
    final Identifier glowTexture = Identifier.of("aporia", "images/particle/glow.png");
