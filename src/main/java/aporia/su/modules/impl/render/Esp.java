...
import aporia.su.util.math.Projection;
import aporia.su.util.modules.esp.RwPrefix;
import aporia.su.util.network.Network;
import aporia.su.util.render.Render2D;
import aporia.su.util.render.font.Fonts;
import aporia.su.util.render.item.ItemRender;
...
public class Esp extends ModuleStructure {
    ...
    Identifier TEXTURE = Identifier.of("aporia", "textures/features/esp/container.png");
