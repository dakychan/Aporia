package aporia.su.util.user.render.screens.menu;
...
import aporia.su.util.files.impl.AccountConfig;
...
public class MainMenuScreen extends Screen {
    ...
    private static final Identifier BACKGROUND_TEXTURE = Identifier.of("aporia", "textures/menu/backmenu.png");
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Fonts.TEST.drawCentered("Aporia.cc © All Rights Reserved", fixedWidth / 2f, fixedHeight - 6, 5f, new Color(128, 128, 128, 128).getRGB());
