    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("aporia", "core/arc_outline"))
                    .withVertexShader(Identifier.of("aporia", "core/arc_outline_vertex"))
                    .withFragmentShader(Identifier.of("aporia", "core/arc_outline_fragment"))
