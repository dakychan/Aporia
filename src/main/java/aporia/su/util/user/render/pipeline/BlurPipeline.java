...
public class BlurPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("aporia", "pipeline/blur");
    private static final Identifier VERTEX_SHADER = Identifier.of("aporia", "core/blur");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("aporia", "core/blur");
