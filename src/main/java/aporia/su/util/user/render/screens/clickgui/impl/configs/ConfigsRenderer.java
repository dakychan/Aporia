package aporia.su.util.user.render.screens.clickgui.impl.configs;

import net.minecraft.client.gui.DrawContext;
import aporia.su.modules.module.category.ModuleCategory;
import aporia.su.util.user.render.screens.clickgui.impl.configs.handler.ConfigAnimationHandler;
import aporia.su.util.user.render.screens.clickgui.impl.configs.handler.ConfigDataHandler;
import aporia.su.util.user.render.screens.clickgui.impl.configs.render.ConfigCreateBoxRenderer;
import aporia.su.util.user.render.screens.clickgui.impl.configs.render.ConfigHeaderRenderer;
import aporia.su.util.user.render.screens.clickgui.impl.configs.render.ConfigListRenderer;
import aporia.su.util.user.render.screens.clickgui.impl.configs.render.ConfigNotificationRenderer;
