package aporia.su.util.user.render.font;
...
public class FontPipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("aporia", "pipeline/msdf");
    private static final Identifier SHADER_ID = Identifier.of("aporia", "core/msdf");
