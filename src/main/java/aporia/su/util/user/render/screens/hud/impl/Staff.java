package aporia.su.util.user.render.screens.hud.impl;
...
import aporia.su.util.user.render.screens.hud.api.AbstractHudElement;
...
public class Staff extends AbstractHudElement {
    ...
    private static final Identifier STEVE_SKIN = Identifier.of("aporia", "textures/entity/player/wide/steve.png");
