package aporia.su.util.user.render.screens.clickgui.impl.autobuy.originalitems;

import net.minecraft.item.Items;
import net.minecraft.text.Text;
import aporia.su.util.user.render.screens.clickgui.impl.autobuy.AutoBuyableItem;
import aporia.su.util.user.render.screens.clickgui.impl.autobuy.items.customitem.CustomItem;
import aporia.su.util.user.render.screens.clickgui.impl.autobuy.items.customitem.UnbreakableItem;
import aporia.su.util.user.render.screens.clickgui.impl.autobuy.items.price.Defaultpricec;
...
public class DonatorProvider {
    public static List<AutoBuyableItem> getDonator() {
        ...
        List<Text> signalaporiaLore = List.of(
                Text.literal("Уровень лута: Богатый"),
                Text.literal("При помощи этого предмета"),
                Text.literal("можно призвать оригинальный"),
                Text.literal("Мистический Сундук!")
        );
        donator.add(new CustomItem("Сигнальный огонь [Богатый]", null, Items.CAMPFIRE, Defaultpricec.getPrice("Сигнальный огонь [Богатый]"), null, signalaporiaLore));
