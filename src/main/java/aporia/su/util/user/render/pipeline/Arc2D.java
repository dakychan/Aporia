    ...
    public static void init() {
        ...
        try {
            pipeline = RenderPipeline.builder()
                    .withLocation(Identifier.of("aporia", "core/arc"))
                    .withVertexShader(Identifier.of("aporia", "core/arc_vertex"))
                    .withFragmentShader(Identifier.of("aporia", "core/arc_fragment"))
