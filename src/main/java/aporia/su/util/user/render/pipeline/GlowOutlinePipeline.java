...
public class GlowOutlinePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("aporia", "pipeline/glow_outline");
    private static final Identifier VERTEX_SHADER = Identifier.of("aporia", "core/glow_outline");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("aporia", "core/glow_outline");
