package aporia.su.util.user.render.screens.clickgui.impl.background;

import net.minecraft.client.gui.DrawContext;
import aporia.su.util.interfaces.IMinecraft;
import aporia.su.modules.module.ModuleStructure;
import aporia.su.modules.module.category.ModuleCategory;
import aporia.su.util.user.render.screens.clickgui.impl.background.render.AvatarRenderer;
import aporia.su.util.user.render.screens.clickgui.impl.background.render.BackgroundRenderer;
import aporia.su.util.user.render.screens.clickgui.impl.background.render.CategoryRenderer;
import aporia.su.util.user.render.screens.clickgui.impl.background.render.HeaderRenderer;
import aporia.su.util.user.render.screens.clickgui.impl.background.search.SearchHandler;
import aporia.su.util.user.render.screens.clickgui.impl.background.search.SearchRenderer;
