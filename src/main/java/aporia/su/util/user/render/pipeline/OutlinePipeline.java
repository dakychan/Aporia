...
public class OutlinePipeline {
    ...
    private static final Identifier PIPELINE_ID = Identifier.of("aporia", "pipeline/outline");
    private static final Identifier VERTEX_SHADER = Identifier.of("aporia", "core/outline");
    private static final Identifier FRAGMENT_SHADER = Identifier.of("aporia", "core/outline");
