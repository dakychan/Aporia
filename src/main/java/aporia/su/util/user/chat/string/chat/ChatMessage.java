package aporia.su.util.user.chat.string.chat;
...
import aporia.su.util.user.chat.string.chat.helper.TextHelper;

public class ChatMessage {
    public static MutableText brandmessage() {
        return (MutableText) TextHelper.applyPredefinedGradient("Aporia.cc", "black_light_purple", true);
    }
    ...
    public static void brandmessage(String message) {
        if (MinecraftClient.getInstance().player != null) {
            Text prefix = TextHelper.applyPredefinedGradient("Aporia.cc -> ", "black_light_purple", true);
