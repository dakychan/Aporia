...
/**
 * Калькулятор для тестирования HEAVY обфускации
 * Классы + методы + поля в unicode кашу
 */
@Obfuscate(level = Obfuscate.Level.HEAVY)
public class CalculatorHeavy {
    
    private double result;
    private String lastOperation;
    
    public CalculatorHeavy() {
        this.result = 0.0;
