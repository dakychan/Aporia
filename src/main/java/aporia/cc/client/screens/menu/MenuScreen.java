package aporia.cc.client.screens.menu;
...
import aporia.cc.client.screens.menu.elements.impl.MenuModuleElement;
import aporia.cc.client.screens.menu.elements.impl.MenuThemeElement;
import aporia.cc.client.screens.menu.panels.HeaderPanel;
import aporia.cc.client.modules.api.Category;
import aporia.cc.client.screens.menu.panels.SidebarPanel;
import aporia.cc.client.screens.menu.settings.api.MenuPopupSetting;
import aporia.cc.utility.render.display.ScrollHandler;
import aporia.cc.utility.game.other.render.CustomScreen;
...
public class MenuScreen extends CustomScreen {
    ...
    public void initialize() {
        modules.addAll(Aporia.getInstance().getModuleManager().getModules().stream().map(MenuModuleElement::new).toList());
    ...
    protected void init() {
        ...
        if (!initialized) {
            ...
            this.headerPanel = new HeaderPanel(
                    ...
                    () -> Aporia.getInstance().getThemeManager().switchTheme()
            );
        }
        initialized = true;
