package aporia.cc.client.screens.menu.elements.impl;
...
import aporia.cc.client.screens.menu.settings.impl.MenuButtonSetting;
import aporia.cc.client.screens.menu.settings.impl.MenuColorSetting;
...
public class MenuThemeElement extends AbstractMenuElement {
    ...
    public MenuThemeElement(Theme theme) {
        ...
        animation = new Animation(200, Aporia.getInstance().getThemeManager().is(theme) ? 1 : 0, Easing.LINEAR);
    ...
    public void render(UIContext ctx, float mouseX, float mouseY, Font font, float x, float y, float moduleWidth, float alpha, int colum) {
        ...
        animation.update(Aporia.getInstance().getThemeManager().is(theme) ? 1 : 0);
    ...
    public void onMouseClicked(double mouseX, double mouseY, MouseButton button) {
        if (bounds != null && bounds.contains(mouseX, mouseY)) {
            Aporia.getInstance().getThemeManager().switchTheme(theme);
        }
        for (MenuSetting setting : settings) {
