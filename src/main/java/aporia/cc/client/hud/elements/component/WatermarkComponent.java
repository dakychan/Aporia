...
import aporia.cc.client.hud.elements.HudElement;
...
public class WatermarkComponent extends DraggableHudElement {
    ...
    public void render(CustomDrawContext ctx) {
        ...
        elements.add(new HudElement("I",()-> mc.player.networkHandler.getServerInfo() == null ? "20" : TextUtil.formatNumber(Aporia.getInstance().getServerHandler().getTPS()).replace(",", ".").replace(".0", "") ,"tps"));
