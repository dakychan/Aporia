package aporia.cc.base.filemanager.api;

import com.google.gson.Gson;
import lombok.Getter;
import aporia.cc.Aporia;
import aporia.cc.utility.crypt.CryptUtility;
...
public class ManagerFileAbstract<T> {
    ...
    public ManagerFileAbstract(String fileName, String shifr, Type type, Supplier<Collection<T>> collectionSupplier) {
        ...
        File file = new File(Aporia.DIRECTORY, fileName);
    ...
    public void save() {
        ...
        try (FileWriter writer = new FileWriter(new File(Aporia.DIRECTORY, fileName))) {
    ...
    public void load() {
        try (BufferedReader reader = new BufferedReader(new FileReader(new File(Aporia.DIRECTORY, fileName)))) {
            Gson gson = new Gson();
