...
import ru.utils.input.api.KeyboardKeys;
...
import ru.utils.ui.clickgui.comp.Slider;
import ru.utils.ui.clickgui.comp.MultiSetting;
import ru.utils.ui.notify.Notify;
import ru.utils.lang.Lang;
...
public class ClickGuiScreen extends Screen {
        ...
        for (Module.Setting<?> setting : settings) {
            ...
            if (setting instanceof Module.NumberSetting) {
                ...
                if (setting instanceof Module.BooleanSetting) {
                    ...
                    Interface.MultiSetting multiSettingData =
                        (Interface.MultiSetting) setting;
    ...
    private void renderDiscordAvatar(int fbWidth, int fbHeight) {
        DiscordManager discordManager = ru.Aporia.getDiscordManager();
