...
public enum KeyboardKeys {
    ...
    private static final Map<Integer, KeyboardKeys> BY_CODE = new HashMap<>();
    private static final Map<String, KeyboardKeys> BY_NAME = new HashMap<>();

    KeyboardKeys(String name, int keyCode) {
        this.name = name;
