...
public final class Easings {
    ...
    public static final Easing ELASTIC_OUT = value -> value != 0.0 && value != 1.0
        ? Math.pow(2.0, -10.0 * value) * Math.sin((value * 10.0 - 0.75) * c4) + 1.0
        : value;
    ...
    public static final Easing BOUNCE_OUT = x -> {
        ...
        if (x < 1.0 / d1) {
            ...
            return x < 2.5 / d1 
                ? n1 * Math.pow(x - 2.25 / d1, 2.0) + 0.9375 
                : n1 * Math.pow(x - 2.625 / d1, 2.0) + 0.984375;
        }
    };
    ...
    public static Easing powInOut(double n) {
        return value -> value < 0.5 
            ? Math.pow(2.0, n - 1.0) * Math.pow(value, n) 
            : 1.0 - Math.pow(-2.0 * value + 2.0, n) / 2.0;
    }
