...
public class KawaseBlurPipeline {
    ...
    private static final Identifier DOWN_PIPELINE_ID = Identifier.fromNamespaceAndPath("aporia", "pipeline/kawase_down");
    private static final Identifier DOWN_VERTEX_SHADER = Identifier.fromNamespaceAndPath("aporia", "core/kawase_down");
    private static final Identifier DOWN_FRAGMENT_SHADER = Identifier.fromNamespaceAndPath("aporia", "core/kawase_down");

    private static final Identifier UP_PIPELINE_ID = Identifier.fromNamespaceAndPath("aporia", "pipeline/kawase_up");
    private static final Identifier UP_VERTEX_SHADER = Identifier.fromNamespaceAndPath("aporia", "core/kawase_up");
    private static final Identifier UP_FRAGMENT_SHADER = Identifier.fromNamespaceAndPath("aporia", "core/kawase_up");

    private static final RenderPipeline.Snippet KAWASE_BASE_SNIPPET = RenderPipeline.builder()
    ...
    private static final RenderPipeline DOWN_PIPELINE = RenderPipeline.builder(KAWASE_BASE_SNIPPET)
    ...
    private static final RenderPipeline UP_PIPELINE = RenderPipeline.builder(KAWASE_BASE_SNIPPET)
