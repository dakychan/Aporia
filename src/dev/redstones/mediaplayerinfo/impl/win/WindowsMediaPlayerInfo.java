...
public class WindowsMediaPlayerInfo implements MediaPlayerInfo {
   ...
   static {
      try {
         ...
         try (InputStream inputStream = WindowsMediaPlayerInfo.class.getResourceAsStream("/mediaplayerinfo/MediaPlayerInfo.dll")) {
            if (inputStream == null) {
               throw new IOException("Resource not found: /mediaplayerinfo/MediaPlayerInfo.dll");
            }
