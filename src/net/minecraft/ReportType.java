...
public record ReportType(String header, List<String> nuggets) {
   public static final net.minecraft.ReportType CRASH = new net.minecraft.ReportType(
   ...
   public static final net.minecraft.ReportType PROFILE = new net.minecraft.ReportType(
   ...
   public static final net.minecraft.ReportType TEST = new net.minecraft.ReportType(
   ...
   public static final net.minecraft.ReportType NETWORK_PROTOCOL_ERROR = new net.minecraft.ReportType(
   ...
   public static final net.minecraft.ReportType CHUNK_IO_ERROR = new net.minecraft.ReportType(
