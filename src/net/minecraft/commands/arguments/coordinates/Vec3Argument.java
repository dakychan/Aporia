...
public class Vec3Argument implements ArgumentType<Coordinates> {
   ...
   public static Vec3 getVec3(CommandContext<CommandSourceStack> p_120845_, String p_120846_) {
      return ((Coordinates)p_120845_.getArgument(p_120846_, Coordinates.class)).getPosition((CommandSourceStack)p_120845_.getSource());
   }
   ...
   public Coordinates parse(StringReader p_120843_) throws CommandSyntaxException {
      return (Coordinates)(
         p_120843_.canRead() && p_120843_.peek() == '^' ? LocalCoordinates.parse(p_120843_) : WorldCoordinates.parseDouble(p_120843_, this.centerCorrect)
      );
   }
