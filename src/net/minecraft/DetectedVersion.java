...
public class DetectedVersion {
   ...
   public static final net.minecraft.WorldVersion BUILT_IN = createBuiltIn(UUID.randomUUID().toString().replaceAll("-", ""), "Development Version");

   public static net.minecraft.WorldVersion createBuiltIn(String p_428778_, String p_429892_) {
      return createBuiltIn(p_428778_, p_429892_, true);
   }

   public static net.minecraft.WorldVersion createBuiltIn(String p_425498_, String p_428529_, boolean p_429114_) {
      return new net.minecraft.WorldVersion.Simple(
         p_425498_,
         p_428529_,
   ...
   private static net.minecraft.WorldVersion createFromJson(JsonObject p_405818_) {
   ...
   public static net.minecraft.WorldVersion tryDetectVersion() {
      try {
         net.minecraft.WorldVersion worldversion;
         try (InputStream inputstream = net.minecraft.DetectedVersion.class.getResourceAsStream("/version.json")) {
            if (inputstream == null) {
         ...
         return worldversion;
      } catch (IOException | JsonParseException var9) {
         throw new IllegalStateException("Game version information is corrupt", var9);
      }
   }
}
