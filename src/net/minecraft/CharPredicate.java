...
public interface CharPredicate {
   ...
   default net.minecraft.CharPredicate and(net.minecraft.CharPredicate p_178287_) {
      Objects.requireNonNull(p_178287_);
      return p_178295_ -> this.test(p_178295_) && p_178287_.test(p_178295_);
   }

   default net.minecraft.CharPredicate negate() {
      return p_178285_ -> !this.test(p_178285_);
   }

   default net.minecraft.CharPredicate or(net.minecraft.CharPredicate p_178292_) {
