...
public class CrashReportCategory {
   ...
   private final List<net.minecraft.CrashReportCategory.Entry> entries = Lists.newArrayList();
   ...
   public net.minecraft.CrashReportCategory setDetail(String p_128166_, net.minecraft.CrashReportDetail<String> p_128167_) {
      try {
         this.setDetail(p_128166_, p_128167_.call());
      } catch (Throwable var4) {
         this.setDetailError(p_128166_, var4);
      }

      return this;
   }

   public net.minecraft.CrashReportCategory setDetail(String p_128160_, Object p_128161_) {
      this.entries.add(new net.minecraft.CrashReportCategory.Entry(p_128160_, p_128161_));
      return this;
   }
   ...
   public void getDetails(StringBuilder p_128169_) {
      ...
      for (net.minecraft.CrashReportCategory.Entry crashreportcategory$entry : this.entries) {
         p_128169_.append("\n\t");
   ...
   public static void populateBlockDetails(net.minecraft.CrashReportCategory p_178951_, LevelHeightAccessor p_178952_, BlockPos p_178953_, BlockState p_178954_) {
      p_178951_.setDetail("Block", p_178954_::toString);
      populateBlockLocationDetails(p_178951_, p_178952_, p_178953_);
   }

   public static net.minecraft.CrashReportCategory populateBlockLocationDetails(
      net.minecraft.CrashReportCategory p_392608_, LevelHeightAccessor p_393277_, BlockPos p_392649_
   ) {
