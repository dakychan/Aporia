...
public class SystemToast implements Toast {
   ...
   public static void onChunkLoadFailure(Minecraft p_335709_, ChunkPos p_330201_) {
      addOrUpdate(
         ...
         Component.translatable("chunk.toast.loadFailure", Component.translationArg(p_330201_)).withStyle(net.minecraft.ChatFormatting.RED),
   ...
   public static void onChunkSaveFailure(Minecraft p_328693_, ChunkPos p_333444_) {
      addOrUpdate(
         ...
         Component.translatable("chunk.toast.saveFailure", Component.translationArg(p_333444_)).withStyle(net.minecraft.ChatFormatting.RED),
         Component.translatable("chunk.toast.checkLog")
      );
   }
