...
public class ComponentRenderUtils {
   ...
   private static String stripColor(String p_94000_) {
      return Minecraft.getInstance().options.chatColors().get() ? p_94000_ : net.minecraft.ChatFormatting.stripFormatting(p_94000_);
   }
   ...
   public static List<FormattedCharSequence> wrapComponents(FormattedText p_94006_, int p_94007_, Font p_94008_) {
      ...
      return (List<FormattedCharSequence>)(list.isEmpty() ? Lists.newArrayList(new FormattedCharSequence[]{FormattedCharSequence.EMPTY}) : list);
   }
}
