...
public class DebugEntryLookingAtFluid implements DebugScreenEntry {
   ...
   public void display(DebugScreenDisplayer p_423650_, @Nullable Level p_431251_, @Nullable LevelChunk p_429048_, @Nullable LevelChunk p_427954_) {
      ...
      Level level = (Level)(net.minecraft.SharedConstants.DEBUG_SHOW_SERVER_DEBUG_VALUES ? p_431251_ : Minecraft.getInstance().level);
      if (entity != null && level != null) {
         ...
         if (hitresult.getType() == HitResult.Type.BLOCK) {
            ...
            list.add(net.minecraft.ChatFormatting.UNDERLINE + "Targeted Fluid: " + blockpos.getX() + ", " + blockpos.getY() + ", " + blockpos.getZ());
   ...
   private String getPropertyValueString(Entry<Property<?>, Comparable<?>> p_430751_) {
      ...
      if (Boolean.TRUE.equals(comparable)) {
         s = net.minecraft.ChatFormatting.GREEN + s;
      } else if (Boolean.FALSE.equals(comparable)) {
         s = net.minecraft.ChatFormatting.RED + s;
      }
