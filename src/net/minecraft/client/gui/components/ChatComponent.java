...
public class ChatComponent {
    ...
    public void clearMessages(final boolean history) {
        ...
        ChatScreenBackendApi.WinMgr.wins.forEach(w -> w.clear());
        if (history) {
    ...
    private void addMessage(
        ...
        if (this.visibleMessageFilter.test(message)) {
            ...
            ChatScreenBackendApi.WinMgr.route(message, this.minecraft.font);
        }
    }
    ...
    private void refreshTrimmedMessages() {
        ...
        ChatScreenBackendApi.WinMgr.rebuild(this, this.minecraft.font);
    }
