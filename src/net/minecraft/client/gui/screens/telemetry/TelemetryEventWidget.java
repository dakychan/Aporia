...
public class TelemetryEventWidget extends AbstractTextAreaWidget {
   ...
   private static final Component PROPERTY_TITLE = Component.translatable("telemetry_info.property_title").withStyle(net.minecraft.ChatFormatting.UNDERLINE);
   ...
   private Component grayOutIfDisabled(Component p_311715_, boolean p_310771_) {
      return (Component)(p_310771_ ? p_311715_.copy().withStyle(net.minecraft.ChatFormatting.GRAY) : p_311715_);
   }
   ...
   private void addEventType(TelemetryEventWidget.ContentBuilder p_261823_, TelemetryEventType p_262127_, boolean p_310858_) {
      ...
      p_261823_.addHeader(this.font, p_262127_.description().withStyle(net.minecraft.ChatFormatting.GRAY));
      p_261823_.addSpacer(4);
