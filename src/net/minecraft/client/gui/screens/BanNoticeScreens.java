...
public class BanNoticeScreens {
   private static final Component TEMPORARY_BAN_TITLE = Component.translatable("gui.banned.title.temporary").withStyle(net.minecraft.ChatFormatting.BOLD);
   private static final Component PERMANENT_BAN_TITLE = Component.translatable("gui.banned.title.permanent").withStyle(net.minecraft.ChatFormatting.BOLD);
   public static final Component NAME_BAN_TITLE = Component.translatable("gui.banned.name.title").withStyle(net.minecraft.ChatFormatting.BOLD);
   private static final Component SKIN_BAN_TITLE = Component.translatable("gui.banned.skin.title").withStyle(net.minecraft.ChatFormatting.BOLD);
   ...
   public static ConfirmLinkScreen create(BooleanConsumer p_299994_, BanDetails p_297408_) {
      return new ConfirmLinkScreen(
         p_299994_, getBannedTitle(p_297408_), getBannedScreenText(p_297408_), CommonLinks.SUSPENSION_HELP, CommonComponents.GUI_ACKNOWLEDGE, true
      );
   }
   ...
   public static ConfirmLinkScreen createNameBan(String p_300838_, Runnable p_297249_) {
      ...
      return new ConfirmLinkScreen(
         ...
         Component.translatable(
            ...
            Component.literal(p_300838_).withStyle(net.minecraft.ChatFormatting.YELLOW),
   ...
   private static Component getBannedScreenText(BanDetails p_299903_) {
      return Component.translatable(
         "gui.banned.description", getBanReasonText(p_299903_), getBanStatusText(p_299903_), Component.translationArg(CommonLinks.SUSPENSION_HELP)
      );
   }
   ...
   private static Component getBanReasonText(BanDetails p_298548_) {
      ...
      if (StringUtils.isNumeric(s)) {
         ...
         if (banreason != null) {
            ...
            component = Component.translatable("gui.banned.description.reason_id_message", i, s1).withStyle(net.minecraft.ChatFormatting.BOLD);
         } else {
            component = Component.translatable("gui.banned.description.reason_id", i).withStyle(net.minecraft.ChatFormatting.BOLD);
         }
   ...
   private static Component getBanStatusText(BanDetails p_298190_) {
      if (isTemporaryBan(p_298190_)) {
         ...
         return Component.translatable(
            ...
            Component.translatable("gui.banned.description.temporary.duration", component).withStyle(net.minecraft.ChatFormatting.BOLD)
         );
      } else {
         return Component.translatable("gui.banned.description.permanent").withStyle(net.minecraft.ChatFormatting.BOLD);
      }
   }
