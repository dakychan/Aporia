...
public class ChatScreen extends Screen {
   ...
   public boolean mouseClicked(MouseButtonEvent p_429485_, boolean p_423918_) {
      if (this.commandSuggestions.mouseClicked(p_429485_)) {
         ...
         Module betterChat = ModuleManager.getInstance().getModuleByName("BetterChat");
         if (betterChat != null && betterChat.isEnabled()) {
            ...
            if (messageText != null && !messageText.isEmpty()) {
               if (this.minecraft.hasShiftDown() && p_429485_.button() == 0) {
                  ...
                  if (ChatUtils.notifyOnCopy) {
                     ChatUtils.INSTANCE.sendMessage("Строка скопирована", MessageType.SUCCESS);
                  }

                  return true;
               }

               if (p_429485_.button() == 1) {
   ...
   private @Nullable FormattedCharSequence formatChat(String p_429271_, int p_423659_) {
      return this.isDraft ? FormattedCharSequence.forward(p_429271_, Style.EMPTY.withColor(net.minecraft.ChatFormatting.GRAY).withItalic(true)) : null;
   }
   ...
   public void handleChatInput(String p_242400_, boolean p_242161_) {
      ...
      if (!p_242400_.isEmpty()) {
         if (ChatUtils.INSTANCE.handleChatMessage(p_242400_)) {
            return;
         }
