...
public abstract class Screen extends AbstractContainerEventHandler implements Renderable {
   ...
   protected static void defaultHandleGameClickEvent(ClickEvent p_408337_, Minecraft p_407842_, @Nullable Screen p_407429_) {
      ...
      switch (p_408337_) {
         case ClickEvent.RunCommand(String var11):
            clickCommandAction(localplayer, var11, p_407429_);
            break;
   ...
   protected static void defaultHandleClickEvent(ClickEvent p_407893_, Minecraft p_410530_, @Nullable Screen p_407004_) {
      boolean flag = switch (p_407893_) {
         case ClickEvent.OpenUrl(URI var17) -> {
            clickUrlAction(p_410530_, p_407004_, var17);
            yield false;
         }
         ...
         case ClickEvent.SuggestCommand(String var22) -> {
            String var18 = var22;
            if (p_407004_ != null) {
               p_407004_.insertText(var18, true);
            }

            yield true;
         }
         case ClickEvent.CopyToClipboard(String var13) -> {
            p_410530_.keyboardHandler.setClipboard(var13);
            yield true;
         }
         default -> {
   ...
   protected void renderMenuBackground(GuiGraphics p_334761_, int p_328355_, int p_328091_, int p_332954_, int p_331811_) {
      renderMenuBackgroundTexture(
         p_334761_, this.minecraft.level == null ? MENU_BACKGROUND : INWORLD_MENU_BACKGROUND, p_328355_, p_328091_, 0.0F, 0.0F, p_332954_, p_331811_
      );
   }
   ...
   public void fillCrashDetails(net.minecraft.CrashReport p_363781_) {
      net.minecraft.CrashReportCategory crashreportcategory = p_363781_.addCategory("Affected screen", 1);
   ...
   private boolean shouldRunNarration() {
      return net.minecraft.SharedConstants.DEBUG_UI_NARRATION || this.minecraft.getNarrator().isActive();
   }
