...
public class WinScreen extends Screen {
   ...
   private static final Component SECTION_HEADING = Component.literal("============").withStyle(net.minecraft.ChatFormatting.WHITE);
   private static final String NAME_PREFIX = "           ";
   private static final String OBFUSCATE_TOKEN = ""
      + net.minecraft.ChatFormatting.WHITE
      + net.minecraft.ChatFormatting.OBFUSCATED
   ...
   private void wrapCreditsIO(Identifier p_460734_, WinScreen.CreditsReader p_197400_) {
      try (Reader reader = this.minecraft.getResourceManager().openAsReader(p_460734_)) {
         ...
         LOGGER.error("Couldn't load credits from file {}", p_460734_, var8);
      }
   }
   ...
   private void addPoemFile(Reader p_232818_) throws IOException {
      ...
      while ((s = bufferedreader.readLine()) != null) {
         ...
         while ((i = s.indexOf(OBFUSCATE_TOKEN)) != -1) {
            ...
            s = s1 + net.minecraft.ChatFormatting.WHITE + net.minecraft.ChatFormatting.OBFUSCATED + "XXXXXXXX".substring(0, randomsource.nextInt(4) + 3) + s2;
         }
   ...
   private void addCreditsFile(Reader p_232820_) {
      for (JsonElement jsonelement : GsonHelper.parseArray(p_232820_)) {
         ...
         this.addCreditsLine(Component.literal(s).withStyle(net.minecraft.ChatFormatting.YELLOW), true, true);
         this.addCreditsLine(SECTION_HEADING, true, false);
         this.addEmptyLine();
         this.addEmptyLine();
         ...
         for (JsonElement jsonelement1 : jsonobject.getAsJsonArray("disciplines")) {
            ...
            if (StringUtils.isNotEmpty(s1)) {
               this.addCreditsLine(Component.literal(s1).withStyle(net.minecraft.ChatFormatting.YELLOW), true, true);
               this.addEmptyLine();
               this.addEmptyLine();
            }
            ...
            for (JsonElement jsonelement2 : jsonobject1.getAsJsonArray("titles")) {
               ...
               this.addCreditsLine(Component.literal(s2).withStyle(net.minecraft.ChatFormatting.GRAY), false, true);

               for (JsonElement jsonelement3 : jsonarray) {
                  String s3 = jsonelement3.getAsString();
                  this.addCreditsLine(Component.literal("           ").append(s3).withStyle(net.minecraft.ChatFormatting.WHITE), false, true);
               }
