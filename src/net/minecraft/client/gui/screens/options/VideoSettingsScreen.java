...
public class VideoSettingsScreen extends OptionsSubScreen {
   ...
   private static final Component IMPROVED_TRANSPARENCY = Component.translatable("options.improvedTransparency").withStyle(net.minecraft.ChatFormatting.ITALIC);
   ...
   private static final Component WARNING_TITLE = Component.translatable("options.graphics.warning.title").withStyle(net.minecraft.ChatFormatting.RED);
   ...
   protected void addOptions() {
      ...
      if (monitor == null) {
         ...
         j = optional.<Integer>map(monitor::getVideoModeIndex).orElse(-1);
      }
      ...
      if (super.mouseClicked(p_428387_, p_424596_)) {
         if (this.gpuWarnlistManager.isShowingWarning()) {
            ...
            if (s != null) {
               ...
               list.add(Component.translatable("options.graphics.warning.renderer", s).withStyle(net.minecraft.ChatFormatting.GRAY));
            }

            String s1 = this.gpuWarnlistManager.getVendorWarnings();
            if (s1 != null) {
               list.add(CommonComponents.NEW_LINE);
               list.add(Component.translatable("options.graphics.warning.vendor", s1).withStyle(net.minecraft.ChatFormatting.GRAY));
            }

            String s2 = this.gpuWarnlistManager.getVersionWarnings();
            if (s2 != null) {
               list.add(CommonComponents.NEW_LINE);
               list.add(Component.translatable("options.graphics.warning.version", s2).withStyle(net.minecraft.ChatFormatting.GRAY));
            }
