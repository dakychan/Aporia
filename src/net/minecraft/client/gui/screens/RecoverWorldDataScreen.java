...
public class RecoverWorldDataScreen extends Screen {
   ...
   private static final Component TITLE = Component.translatable("recover_world.title").withStyle(net.minecraft.ChatFormatting.BOLD);
   ...
   private static final Component NO_ISSUES = Component.translatable("recover_world.issue.none").withStyle(net.minecraft.ChatFormatting.GREEN);
   private static final Component MISSING_FILE = Component.translatable("recover_world.issue.missing_file").withStyle(net.minecraft.ChatFormatting.RED);
   ...
   public RecoverWorldDataScreen(Minecraft p_310416_, BooleanConsumer p_312140_, LevelStorageSource.LevelStorageAccess p_310102_) {
      ...
      this.message = Component.translatable("recover_world.message", Component.literal(p_310102_.getLevelId()).withStyle(net.minecraft.ChatFormatting.GRAY));
   ...
   private Component buildInfo(LevelStorageSource.LevelStorageAccess p_311955_, boolean p_311169_, @Nullable Exception p_312117_) {
      if (p_311169_ && p_312117_ instanceof FileNotFoundException) {
         ...
         mutablecomponent.append(Component.translatable("recover_world.state_entry", mutablecomponent1.withStyle(net.minecraft.ChatFormatting.GRAY)));
         if (p_312117_ == null) {
            ...
            mutablecomponent.append(Component.literal(p_312117_.getCause().toString()).withStyle(net.minecraft.ChatFormatting.RED));
         } else {
            mutablecomponent.append(Component.literal(p_312117_.toString()).withStyle(net.minecraft.ChatFormatting.RED));
         }
   ...
   private @Nullable Exception collectIssue(LevelStorageSource.LevelStorageAccess p_311404_, boolean p_311931_) {
      try {
         ...
         return null;
      } catch (ReportedNbtException | IOException | NbtException var4) {
         return var4;
      }
   }
