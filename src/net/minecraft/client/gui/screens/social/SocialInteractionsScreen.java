...
public class SocialInteractionsScreen extends Screen {
   ...
   private static final Component TAB_ALL_SELECTED = TAB_ALL.plainCopy().withStyle(net.minecraft.ChatFormatting.UNDERLINE);
   private static final Component TAB_HIDDEN_SELECTED = TAB_HIDDEN.plainCopy().withStyle(net.minecraft.ChatFormatting.UNDERLINE);
   private static final Component TAB_BLOCKED_SELECTED = TAB_BLOCKED.plainCopy().withStyle(net.minecraft.ChatFormatting.UNDERLINE);
   ...
   static final Component EMPTY_SEARCH = Component.translatable("gui.socialInteractions.search_empty").withStyle(net.minecraft.ChatFormatting.GRAY);
   private static final Component EMPTY_HIDDEN = Component.translatable("gui.socialInteractions.empty_hidden").withStyle(net.minecraft.ChatFormatting.GRAY);
   private static final Component EMPTY_BLOCKED = Component.translatable("gui.socialInteractions.empty_blocked").withStyle(net.minecraft.ChatFormatting.GRAY);
