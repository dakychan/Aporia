...
public class ReportReasonSelectionScreen extends Screen {
   ...
   final net.minecraft.client.multiplayer.chat.report.ReportType reportType;

   public ReportReasonSelectionScreen(
      @Nullable Screen p_239438_,
      @Nullable ReportReason p_239439_,
      net.minecraft.client.multiplayer.chat.report.ReportType p_362010_,
      Consumer<ReportReason> p_239440_
   ) {
      super(REASON_TITLE);
   ...
   protected void init() {
      ...
      ReportReasonSelectionScreen.ReasonSelectionList.Entry reportreasonselectionscreen$reasonselectionlist$entry = net.minecraft.Optionull.map(
