...
public class SkinReportScreen extends AbstractReportScreen<SkinReport.Builder> {
   ...
   protected void addContent() {
      ...
      this.selectReasonButton = Button.builder(
            SELECT_REASON,
            p_357696_ -> this.minecraft
               .setScreen(
                  new ReportReasonSelectionScreen(
                     this, this.reportBuilder.reason(), net.minecraft.client.multiplayer.chat.report.ReportType.SKIN, p_299180_ -> {
      ...
      this.commentBox = this.createCommentBox(178, 72, p_300794_ -> {
