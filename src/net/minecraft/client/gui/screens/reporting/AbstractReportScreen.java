...
public abstract class AbstractReportScreen<B extends Report.Builder<?>> extends Screen {
   ...
   private static final Component REPORT_SENT_TITLE = Component.translatable("gui.abuseReport.sent.title").withStyle(net.minecraft.ChatFormatting.BOLD);
   private static final Component REPORT_ERROR_TITLE = Component.translatable("gui.abuseReport.error.title").withStyle(net.minecraft.ChatFormatting.BOLD);
   ...
   protected void onReportChanged() {
      ...
      this.sendButton.setTooltip(net.minecraft.Optionull.map(report$cannotbuildreason, Report.CannotBuildReason::tooltip));
   }
   ...
   private void displayReportSendError(Component p_301245_) {
      Component component = p_301245_.copy().withStyle(net.minecraft.ChatFormatting.RED);
      this.minecraft
