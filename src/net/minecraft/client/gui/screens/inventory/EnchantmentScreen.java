      ...
      for (int j = 0; j < 3; j++) {
         ...
         if (!optional.isEmpty()) {
            ...
            if (this.isHovering(60, 14 + 19 * j, 108, 17, p_282491_, p_281953_) && k > 0 && l >= 0) {
               ...
               list.add(
                  Component.translatable("container.enchant.clue", Enchantment.getFullname(optional.get(), l)).withStyle(net.minecraft.ChatFormatting.WHITE)
               );
               if (!flag) {
                  list.add(CommonComponents.EMPTY);
                  if (this.minecraft.player.experienceLevel < k) {
                     list.add(Component.translatable("container.enchant.level.requirement", this.menu.costs[j]).withStyle(net.minecraft.ChatFormatting.RED));
                  } else {
                     ...
                     list.add(mutablecomponent.withStyle(i >= i1 ? net.minecraft.ChatFormatting.GRAY : net.minecraft.ChatFormatting.RED));
                     ...
                     list.add(mutablecomponent1.withStyle(net.minecraft.ChatFormatting.GRAY));
                  }
               }
