   ...
   public List<T> search(String p_119974_) {
      ...
      while (j < k) {
         ...
         if (DEBUG_COMPARISONS) {
            LOGGER.debug("comparing lower \"{}\" with {} \"{}\": {}", new Object[]{p_119974_, l, this.getString(l), i1});
         }
      ...
      if (j >= 0 && j < i) {
         ...
         while (j < k) {
            ...
            if (DEBUG_COMPARISONS) {
               LOGGER.debug("comparing upper \"{}\" with {} \"{}\": {}", new Object[]{p_119974_, j2, this.getString(j2), j1});
            }
