...
public class KeyMapping implements Comparable<KeyMapping> {
   ...
   public static void click(Key p_90836_) {
      forAllKeyMappings(p_90836_, p_420622_ -> p_420622_.clickCount++);
   }

   public static void set(Key p_90838_, boolean p_90839_) {
      forAllKeyMappings(p_90838_, p_420621_ -> p_420621_.setDown(p_90839_));
   }

   private static void forAllKeyMappings(Key p_424096_, Consumer<KeyMapping> p_427756_) {
   ...
   public KeyMapping(String p_90821_, int p_90822_, KeyMapping.Category p_426799_) {
      this(p_90821_, Type.KEYSYM, p_90822_, p_426799_);
   }

   public KeyMapping(String p_90825_, Type p_90826_, int p_90827_, KeyMapping.Category p_427928_) {
      this(p_90825_, p_90826_, p_90827_, p_427928_, 0);
   }

   public KeyMapping(String p_455154_, Type p_460964_, int p_457112_, KeyMapping.Category p_455367_, int p_460901_) {
      this.name = p_455154_;
   ...
   public void setKey(Key p_90849_) {
      this.key = p_90849_;
   }
   ...
   public boolean matches(KeyEvent p_425821_) {
      return p_425821_.key() == InputConstants.UNKNOWN.getValue()
         ? this.key.getType() == Type.SCANCODE && this.key.getValue() == p_425821_.scancode()
         : this.key.getType() == Type.KEYSYM && this.key.getValue() == p_425821_.key();
   }

   public boolean matchesMouse(MouseButtonEvent p_424724_) {
      return this.key.getType() == Type.MOUSE && this.key.getValue() == p_424724_.button();
   }
   ...
   private void registerMapping(Key p_423386_) {
