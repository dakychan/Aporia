...
public class ItemPickupParticleGroup extends ParticleGroup<ItemPickupParticle> {
   ...
   record ParticleInstance(EntityRenderState itemRenderState, double xOffset, double yOffset, double zOffset) {
      public static ItemPickupParticleGroup.ParticleInstance fromParticle(ItemPickupParticle p_428662_, Camera p_423054_, float p_430102_) {
         ...
         f *= f;
         double d0 = Mth.lerp((double)p_430102_, p_428662_.targetXOld, p_428662_.targetX);
         double d1 = Mth.lerp((double)p_430102_, p_428662_.targetYOld, p_428662_.targetY);
         double d2 = Mth.lerp((double)p_430102_, p_428662_.targetZOld, p_428662_.targetZ);
         double d3 = Mth.lerp((double)f, p_428662_.itemRenderState.x, d0);
         double d4 = Mth.lerp((double)f, p_428662_.itemRenderState.y, d1);
         double d5 = Mth.lerp((double)f, p_428662_.itemRenderState.z, d2);
