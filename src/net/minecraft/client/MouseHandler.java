...
public class MouseHandler {
   ...
   private void onButton(long p_428888_, MouseButtonInfo p_424132_, @MouseButtonInfo.Action int p_423948_) {
      ...
      if (p_428888_ == window.handle()) {
            ...
            if (this.minecraft.screen == null) {
               ...
               if (flag) {
                  ...
                  try {
                     ...
                     net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var18, "mouseClicked event handler");
                     screen.fillCrashDetails(crashreport);
                     net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Mouse");
                  ...
                  try {
                     ...
                     net.minecraft.CrashReport crashreport1 = net.minecraft.CrashReport.forThrowable(var17, "mouseReleased event handler");
                     screen.fillCrashDetails(crashreport1);
                     net.minecraft.CrashReportCategory crashreportcategory1 = crashreport1.addCategory("Mouse");
         ...
         if (this.minecraft.screen == null && this.minecraft.getOverlay() == null) {
            ...
            Key inputconstants$key = Type.MOUSE.getOrCreate(mousebuttoninfo.button());
   ...
   public void fillMousePositionDetails(net.minecraft.CrashReportCategory p_398230_, Window p_398216_) {
      p_398230_.setDetail(
         "Mouse location",
         () -> String.format(
            Locale.ROOT, "Scaled: (%f, %f). Absolute: (%f, %f)", getScaledXPos(p_398216_, this.xpos), getScaledYPos(p_398216_, this.ypos), this.xpos, this.ypos
         )
      );
      p_398230_.setDetail(
         "Screen size",
         ...
         (p_340767_, p_340768_, p_340769_) -> {
            ...
            for (int j = 0; j < p_340768_; j++) {
               ...
               try {
                  ...
                  i++;
                  LOGGER.error("Failed to parse path '{}'", s, var11);
               }
            }
      ...
      if (this.minecraft.isWindowActive()) {
         ...
         if (screen != null && this.minecraft.getOverlay() == null && flag) {
            ...
            try {
               ...
               net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var20, "mouseMoved event handler");
               screen.fillCrashDetails(crashreport);
               net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Mouse");
               this.fillMousePositionDetails(crashreportcategory, window);
               throw new net.minecraft.ReportedException(crashreport);
            ...
            if (this.activeButton != null && this.mousePressedTime > 0.0) {
               ...
               try {
                  ...
                  net.minecraft.CrashReport crashreport1 = net.minecraft.CrashReport.forThrowable(var19, "mouseDragged event handler");
                  screen.fillCrashDetails(crashreport1);
                  net.minecraft.CrashReportCategory crashreportcategory1 = crashreport1.addCategory("Mouse");
                  this.fillMousePositionDetails(crashreportcategory1, window);
                  throw new net.minecraft.ReportedException(crashreport1);
