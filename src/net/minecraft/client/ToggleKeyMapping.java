...
public class ToggleKeyMapping extends KeyMapping {
   ...
   public ToggleKeyMapping(String p_92529_, int p_92530_, KeyMapping.Category p_429407_, BooleanSupplier p_92532_, boolean p_428841_) {
      this(p_92529_, Type.KEYSYM, p_92530_, p_429407_, p_92532_, p_428841_);
   }

   public ToggleKeyMapping(String p_426167_, Type p_427837_, int p_425923_, KeyMapping.Category p_422745_, BooleanSupplier p_431674_, boolean p_430720_) {
   ...
   public boolean shouldRestoreStateOnScreenClosed() {
      boolean flag = this.shouldRestore && this.needsToggle.getAsBoolean() && this.key.getType() == Type.KEYSYM && this.releasedByScreenWhenDown;
