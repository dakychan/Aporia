...
public class ClientDebugSubscriber {
   ...
   private Set<DebugSubscription<?>> requestedSubscriptions() {
      ...
      if (net.minecraft.SharedConstants.DEBUG_ENABLED) {
         addFlag(set, DebugSubscriptions.BEES, net.minecraft.SharedConstants.DEBUG_BEES);
         addFlag(set, DebugSubscriptions.BEE_HIVES, net.minecraft.SharedConstants.DEBUG_BEES);
         addFlag(set, DebugSubscriptions.BRAINS, net.minecraft.SharedConstants.DEBUG_BRAIN);
         addFlag(set, DebugSubscriptions.BREEZES, net.minecraft.SharedConstants.DEBUG_BREEZE_MOB);
         addFlag(set, DebugSubscriptions.ENTITY_BLOCK_INTERSECTIONS, net.minecraft.SharedConstants.DEBUG_ENTITY_BLOCK_INTERSECTION);
         addFlag(set, DebugSubscriptions.ENTITY_PATHS, net.minecraft.SharedConstants.DEBUG_PATHFINDING);
         addFlag(set, DebugSubscriptions.GAME_EVENTS, net.minecraft.SharedConstants.DEBUG_GAME_EVENT_LISTENERS);
         addFlag(set, DebugSubscriptions.GAME_EVENT_LISTENERS, net.minecraft.SharedConstants.DEBUG_GAME_EVENT_LISTENERS);
         addFlag(set, DebugSubscriptions.GOAL_SELECTORS, net.minecraft.SharedConstants.DEBUG_GOAL_SELECTOR || net.minecraft.SharedConstants.DEBUG_BEES);
         addFlag(set, DebugSubscriptions.NEIGHBOR_UPDATES, net.minecraft.SharedConstants.DEBUG_NEIGHBORSUPDATE);
         addFlag(set, DebugSubscriptions.POIS, net.minecraft.SharedConstants.DEBUG_POI);
         addFlag(set, DebugSubscriptions.RAIDS, net.minecraft.SharedConstants.DEBUG_RAIDS);
         addFlag(set, DebugSubscriptions.REDSTONE_WIRE_ORIENTATIONS, net.minecraft.SharedConstants.DEBUG_EXPERIMENTAL_REDSTONEWIRE_UPDATE_ORDER);
         addFlag(set, DebugSubscriptions.STRUCTURES, net.minecraft.SharedConstants.DEBUG_STRUCTURES);
         addFlag(set, DebugSubscriptions.VILLAGE_SECTIONS, net.minecraft.SharedConstants.DEBUG_VILLAGE_SECTIONS);
      }
