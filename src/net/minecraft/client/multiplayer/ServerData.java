...
public class ServerData {
   ...
   public long ping;
   public int protocol = net.minecraft.SharedConstants.getCurrentVersion().protocolVersion();
   public Component version = Component.literal(net.minecraft.SharedConstants.getCurrentVersion().name());
