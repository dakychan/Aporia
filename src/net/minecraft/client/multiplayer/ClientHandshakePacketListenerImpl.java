...
public class ClientHandshakePacketListenerImpl implements ClientLoginPacketListener {
   ...
   private @Nullable Component authenticateServer(String p_104532_) {
      ...
      } catch (UserBannedException | ForcedUsernameChangeException var6) {
   ...
   @Override
   public void fillListenerSpecificCrashDetails(net.minecraft.CrashReport p_342297_, net.minecraft.CrashReportCategory p_311844_) {
