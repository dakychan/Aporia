...
public abstract class ClientCommonPacketListenerImpl implements ClientCommonPacketListener {
   ...
   private Optional<Path> storeDisconnectionReport(@Nullable Packet p_344412_, Throwable p_344707_) {
      net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(p_344707_, "Packet handling error");
      ...
      return crashreport.saveToFile(path1, net.minecraft.ReportType.NETWORK_PROTOCOL_ERROR, list) ? Optional.of(path1) : Optional.empty();
   }
   ...
   public void handleResourcePackPop(ClientboundResourcePackPopPacket p_311803_) {
      ...
      p_311803_.id()
         .ifPresentOrElse(p_308277_ -> this.minecraft.getDownloadedPackSource().popPack(p_308277_), () -> this.minecraft.getDownloadedPackSource().popAll());
   }
   ...
   public void handleServerLinks(ClientboundServerLinksPacket p_342144_) {
      ...
      for (ServerLinks.UntrustedEntry serverlinks$untrustedentry : list) {
         try {
            ...
            LOGGER.warn("Received invalid link for type {}:{}", new Object[]{serverlinks$untrustedentry.type(), serverlinks$untrustedentry.link(), var7});
         }
      }
   ...
   @Override
   public void fillListenerSpecificCrashDetails(net.minecraft.CrashReport p_342520_, net.minecraft.CrashReportCategory p_309761_) {
      ...
      if (!this.customReportDetails.isEmpty()) {
         net.minecraft.CrashReportCategory crashreportcategory = p_342520_.addCategory("Custom Server Details");
   ...
   class PackConfirmScreen extends ConfirmScreen {
      ...
      PackConfirmScreen(
         ...
         final @Nullable List<ClientCommonPacketListenerImpl.PackConfirmScreen.PendingRequest> p_312458_,
