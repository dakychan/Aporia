...
public interface AbuseReportSender {
   ...
   CompletableFuture<Unit> send(UUID var1, net.minecraft.client.multiplayer.chat.report.ReportType var2, AbuseReport var3);
   ...
   public record Services(ReportEnvironment environment, UserApiService userApiService) implements AbuseReportSender {
      ...
      @Override
      public CompletableFuture<Unit> send(UUID p_239470_, net.minecraft.client.multiplayer.chat.report.ReportType p_297714_, AbuseReport p_239471_) {
         return CompletableFuture.supplyAsync(
            () -> {
               ...
               try {
                  ...
                  Component component1 = this.getHttpErrorDescription(var7);
                  throw new CompletionException(new AbuseReportSender.SendException(component1, var7));
               } catch (MinecraftClientException var8) {
                  Component component = this.getErrorDescription(var8);
