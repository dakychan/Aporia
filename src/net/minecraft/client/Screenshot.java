               ...
               .execute(
                  () -> {
                     try {
                        ...
                        p_92301_.accept(Component.translatable("screenshot.failure", var8.getMessage()));
                     }
                  }
               );
         }
      ...
      if (gputexture == null) {
         ...
         RenderSystem.getDevice()
            ...
            .copyTextureToBuffer(
               ...
               0L,
               () -> {
                  MappedView gpubuffer$mappedview = commandencoder.mapBuffer(gpubuffer, true, false);
