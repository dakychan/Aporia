...
public class LeashFeatureRenderer {
   ...
   private static void addVertexPair(
      ...
      int i = (int)Mth.lerp(f, (float)p_430731_.startBlockLight, (float)p_430731_.endBlockLight);
      int j = (int)Mth.lerp(f, (float)p_430731_.startSkyLight, (float)p_430731_.endSkyLight);
