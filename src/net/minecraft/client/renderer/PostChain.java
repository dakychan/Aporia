...
public class PostChain implements AutoCloseable {
   ...
   private static PostPass createPass(TextureManager p_366006_, PostChainConfig.Pass p_368358_, Identifier p_450590_) throws ShaderManager.CompilationException {
      com.mojang.blaze3d.pipeline.RenderPipeline.Builder renderpipeline$builder = RenderPipeline.builder(new Snippet[]{RenderPipelines.POST_PROCESSING_SNIPPET})
      ...
      for (PostChainConfig.Input postchainconfig$input1 : p_368358_.inputs()) {
         switch (postchainconfig$input1) {
            case PostChainConfig.TextureInput(String abstracttexture, Identifier var36, int var37, int var38, boolean var39):
               AbstractTexture abstracttexturex = p_366006_.getTexture(var36.withPath(p_357869_ -> "textures/effect/" + p_357869_ + ".png"));
               list.add(new PostPass.TextureInput(abstracttexture, abstracttexturex, var37, var38, var39));
               break;
            case PostChainConfig.TargetInput(String var22, Identifier var41, boolean var42, boolean var43):
               list.add(new PostPass.TargetInput(var22, var41, var42, var43));
               break;
            default:
