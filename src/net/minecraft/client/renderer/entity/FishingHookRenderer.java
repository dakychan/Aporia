...
public class FishingHookRenderer extends EntityRenderer<FishingHook, FishingHookRenderState> {
   ...
   private static void vertex(VertexConsumer p_254464_, Pose p_328848_, int p_254296_, float p_253632_, int p_254132_, int p_254171_, int p_254026_) {
   ...
   private static void stringVertex(
      float p_174119_, float p_174120_, float p_174121_, VertexConsumer p_174122_, Pose p_174123_, float p_174124_, float p_174125_, float p_460475_
   ) {
