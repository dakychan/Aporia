...
public class EntityRenderDispatcher implements ResourceManagerReloadListener {
   ...
   public <E extends Entity> EntityRenderState extractEntity(E p_428219_, float p_430777_) {
      ...
      try {
         ...
         net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var8, "Extracting render state for an entity in world");
         net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Entity being extracted");
         p_428219_.fillCrashReportCategory(crashreportcategory);
         net.minecraft.CrashReportCategory crashreportcategory1 = this.fillRendererDetails(entityrenderer, crashreport);
   ...
   public <S extends EntityRenderState> void submit(
      ...
      try {
         ...
         net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var19, "Rendering entity in world");
         net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("EntityRenderState being rendered");
   ...
   private <S extends EntityRenderState> net.minecraft.CrashReportCategory fillRendererDetails(
      EntityRenderer<?, S> p_396247_, net.minecraft.CrashReport p_396589_
   ) {
      net.minecraft.CrashReportCategory crashreportcategory = p_396589_.addCategory("Renderer details");
