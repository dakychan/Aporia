...
public class FogRenderer implements AutoCloseable {
    ...
    public FogData setupFog(
        ...
        if (so.aporia.module.impl.render.WorldRenderer.customFogActive) {
            fog.environmentalStart = so.aporia.module.impl.render.WorldRenderer.fogStartDist * renderDistanceInBlocks;
            fog.environmentalEnd = so.aporia.module.impl.render.WorldRenderer.fogEndDist * renderDistanceInBlocks;
            fog.renderDistanceEnd /= so.aporia.module.impl.render.WorldRenderer.fogDensityMod;
        }
        return fog;
    }
