...
public class SkyRenderer implements AutoCloseable {
   ...
   public SkyRenderer(TextureManager p_453279_, AtlasManager p_459982_) {
      ...
      ByteBufferBuilder bytebufferbuilder = ByteBufferBuilder.exactlySized(10 * DefaultVertexFormat.POSITION.getVertexSize());

      try {
         BufferBuilder bufferbuilder = new BufferBuilder(bytebufferbuilder, Mode.TRIANGLE_FAN, DefaultVertexFormat.POSITION);
         ...
         bufferbuilder = new BufferBuilder(bytebufferbuilder, Mode.TRIANGLE_FAN, DefaultVertexFormat.POSITION);
         this.buildSkyDisc(bufferbuilder, -16.0F);
   ...
   private GpuBuffer buildSunriseFan() {
      ...
      ByteBufferBuilder bytebufferbuilder = ByteBufferBuilder.exactlySized(18 * j);
   ...
   private static GpuBuffer buildMoonPhases(TextureAtlas p_451349_) {
      ...
      VertexFormat vertexformat = DefaultVertexFormat.POSITION_TEX;
      ByteBufferBuilder bytebufferbuilder = ByteBufferBuilder.exactlySized(amoonphase.length * 4 * vertexformat.getVertexSize());
   ...
   public void renderSunMoonAndStars(
      PoseStack p_362673_, float p_369057_, float p_366540_, float p_368016_, MoonPhase p_450395_, float p_460477_, float p_451875_
   ) {
      p_362673_.pushPose();
