...
public class BlockRenderDispatcher implements ResourceManagerReloadListener {
   ...
   public void renderBatched(
      ...
      try {
         ...
         net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var11, "Tesselating block in world");
         net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Block being tesselated");
         net.minecraft.CrashReportCategory.populateBlockDetails(crashreportcategory, p_234358_, p_234357_, p_234356_);
   ...
   public void renderLiquid(BlockPos p_234364_, BlockAndTintGetter p_234365_, VertexConsumer p_234366_, BlockState p_234367_, FluidState p_234368_) {
      try {
         ...
         net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var9, "Tesselating liquid in world");
         net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Block being tesselated");
         net.minecraft.CrashReportCategory.populateBlockDetails(crashreportcategory, p_234365_, p_234364_, p_234367_);
         throw new net.minecraft.ReportedException(crashreport);
      }
   }
