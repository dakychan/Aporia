...
public class ModelBlockRenderer {
   ...
   public void tesselateBlock(
      ...
      if (!p_393688_.isEmpty()) {
         ...
         try {
            ...
            net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var13, "Tesselating block model");
            net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Block model being tesselated");
            net.minecraft.CrashReportCategory.populateBlockDetails(crashreportcategory, p_234380_, p_234383_, p_234382_);
   ...
   public static void renderModel(
      Pose p_111068_, VertexConsumer p_111069_, BlockStateModel p_397754_, float p_111072_, float p_111073_, float p_111074_, int p_111075_, int p_111076_
   ) {
   ...
   private static void renderQuadList(
      Pose p_111059_, VertexConsumer p_111060_, float p_111061_, float p_111062_, float p_111063_, List<BakedQuad> p_111064_, int p_111065_, int p_111066_
   ) {
   ...
   static class AmbientOcclusionRenderStorage extends ModelBlockRenderer.CommonRenderStorage {
      ...
      private static int blend(int p_395262_, int p_396930_, int p_395695_, int p_393923_, float p_397544_, float p_391464_, float p_398036_, float p_397919_) {
         int i = (int)(
