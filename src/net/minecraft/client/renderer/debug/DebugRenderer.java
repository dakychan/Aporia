...
public class DebugRenderer {
   ...
   public void refreshRendererList() {
      ...
      if (net.minecraft.SharedConstants.DEBUG_PATHFINDING) {
      ...
      if (net.minecraft.SharedConstants.DEBUG_NEIGHBORSUPDATE) {
         this.renderers.add(new NeighborsUpdateRenderer());
      }

      if (net.minecraft.SharedConstants.DEBUG_EXPERIMENTAL_REDSTONEWIRE_UPDATE_ORDER) {
         this.renderers.add(new RedstoneWireOrientationsRenderer());
      }

      if (net.minecraft.SharedConstants.DEBUG_STRUCTURES) {
      ...
      if (net.minecraft.SharedConstants.DEBUG_VILLAGE_SECTIONS) {
         this.renderers.add(new VillageSectionsDebugRenderer());
      }

      if (net.minecraft.SharedConstants.DEBUG_BRAIN) {
         this.renderers.add(new BrainDebugRenderer(minecraft));
      }

      if (net.minecraft.SharedConstants.DEBUG_POI) {
         this.renderers.add(new PoiDebugRenderer(new BrainDebugRenderer(minecraft)));
      }

      if (net.minecraft.SharedConstants.DEBUG_BEES) {
         this.renderers.add(new BeeDebugRenderer(minecraft));
      }

      if (net.minecraft.SharedConstants.DEBUG_RAIDS) {
         this.renderers.add(new RaidDebugRenderer(minecraft));
      }

      if (net.minecraft.SharedConstants.DEBUG_GOAL_SELECTOR) {
      ...
      if (net.minecraft.SharedConstants.DEBUG_GAME_EVENT_LISTENERS) {
      ...
      if (net.minecraft.SharedConstants.DEBUG_BREEZE_MOB) {
         this.renderers.add(new BreezeDebugRenderer(minecraft));
      }

      if (net.minecraft.SharedConstants.DEBUG_ENTITY_BLOCK_INTERSECTION) {
