...
public class ResourceLoadStateTracker {
   ...
   public void fillCrashReport(net.minecraft.CrashReport p_168563_) {
      net.minecraft.CrashReportCategory crashreportcategory = p_168563_.addCategory("Last reload");
   ...
   static class RecoveryInfo {
      ...
      public void fillCrashInfo(net.minecraft.CrashReportCategory p_168569_) {
   ...
   static class ReloadState {
      ...
      public void fillCrashInfo(net.minecraft.CrashReportCategory p_168593_) {
