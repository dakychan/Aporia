...
public class ClientPackSource extends BuiltInPackSource {
    ...
    private static VanillaPackResources createVanillaPackSource(Path p_250749_) {
        ...
        Path assetsDir = java.nio.file.Paths.get(System.getProperty("user.home"), ".apr", ".assets");
        ...
        if (java.nio.file.Files.exists(ccAssetsDir)) {
            vanillapackresourcesbuilder.pushAssetPath(PackType.CLIENT_RESOURCES, ccAssetsDir);
        }
