...
public class GameLoadTimesEvent {
   ...
   public synchronized void beginStep(TelemetryProperty<GameLoadTimesEvent.Measurement> p_286394_) {
      this.beginStep(p_286394_, (Function<TelemetryProperty<GameLoadTimesEvent.Measurement>, Stopwatch>)(p_286494_ -> Stopwatch.createStarted(this.timeSource)));
   }

   public synchronized void beginStep(TelemetryProperty<GameLoadTimesEvent.Measurement> p_286396_, Stopwatch p_286822_) {
      this.beginStep(p_286396_, (Function<TelemetryProperty<GameLoadTimesEvent.Measurement>, Stopwatch>)(p_286421_ -> p_286822_));
   }
