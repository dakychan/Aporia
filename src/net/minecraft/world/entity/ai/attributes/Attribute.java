...
public class Attribute {
   ...
   public net.minecraft.ChatFormatting getStyle(boolean p_343100_) {
   ...
   public static enum Sentiment {
      ...
      public net.minecraft.ChatFormatting getStyle(boolean p_342401_) {
         return switch (this) {
            case POSITIVE -> p_342401_ ? net.minecraft.ChatFormatting.BLUE : net.minecraft.ChatFormatting.RED;
            case NEUTRAL -> net.minecraft.ChatFormatting.GRAY;
            case NEGATIVE -> p_342401_ ? net.minecraft.ChatFormatting.RED : net.minecraft.ChatFormatting.BLUE;
         };
      }
   }
}
