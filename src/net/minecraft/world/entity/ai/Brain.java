...
public class Brain<E extends LivingEntity> {
   ...
   public static <E extends LivingEntity> Codec<Brain<E>> codec(
         ...
         (new MapCodec<Brain<E>>() {
               public <T> Stream<T> keys(DynamicOps<T> p_22029_) {
                  return p_21947_.stream()
                     ...
                     .map(p_449438_ -> (T)p_22029_.createString(p_449438_.toString()));
               }
                     ...
                     .forEach(
                        p_449436_ -> {
                           DataResult<MemoryModuleType<?>> dataresult = BuiltInRegistries.MEMORY_MODULE_TYPE
                              .byNameCodec()
                              .parse(p_22022_, p_449436_.getFirst());
                           DataResult<? extends Brain.MemoryValue<?>> dataresult1 = dataresult.flatMap(
                              p_147350_ -> this.captureRead(p_147350_, p_22022_, (T)p_449436_.getSecond())
                           );
                           mutableobject1.setValue(((DataResult)mutableobject1.get()).apply2(Builder::add, dataresult1));
                        }
                     );
                  ImmutableList<Brain.MemoryValue<?>> immutablelist = ((DataResult)mutableobject1.get())
               ...
               private <T, U> DataResult<Brain.MemoryValue<U>> captureRead(MemoryModuleType<U> p_21997_, DynamicOps<T> p_21998_, T p_21999_) {
                  return p_21997_.getCodec()
                     ...
                     .flatMap(p_22011_ -> p_22011_.parse(p_21998_, p_21999_))
      ...
      return (Codec<Brain<E>>)mutableobject.get();
   }
   ...
   public Brain(
      ...
      UnmodifiableIterator var11 = p_21857_.iterator();

      while (var11.hasNext()) {
         Brain.MemoryValue<?> memoryvalue = (Brain.MemoryValue<?>)var11.next();
   ...
   public void addActivityWithConditions(
      Activity p_397667_, int p_392126_, ImmutableList<? extends BehaviorControl<? super E>> p_397539_, Set<Pair<MemoryModuleType<?>, MemoryStatus>> p_391610_
   ) {
   ...
   public void addActivityAndRemoveMemoriesWhenStopped(
      ...
      while (var5.hasNext()) {
         ...
         this.availableBehaviorsByPriority
            .computeIfAbsent((Integer)pair.getFirst(), p_21917_ -> Maps.newHashMap())
   ...
   ImmutableList<? extends Pair<Integer, ? extends BehaviorControl<? super E>>> createPriorityPairs(
      ...
      while (var5.hasNext()) {
         BehaviorControl<? super E> behaviorcontrol = (BehaviorControl<? super E>)var5.next();
               ...
               p_22053_ -> this.value
                  .ifPresent(
                     p_358912_ -> p_22049_.add(
                        BuiltInRegistries.MEMORY_MODULE_TYPE.byNameCodec().encodeStart(p_22048_, this.type), p_22053_.encodeStart(p_22048_, p_358912_)
                     )
                  )
            );
      }
