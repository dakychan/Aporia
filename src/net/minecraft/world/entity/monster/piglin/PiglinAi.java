...
public class PiglinAi {
   ...
   private static void initIdleActivity(Brain<Piglin> p_34892_) {
      p_34892_.addActivity(
         ...
         ImmutableList.of(
            ...
            StartAttacking.create((p_449713_, p_449714_) -> p_449714_.isAdult(), PiglinAi::findNearestValidAttackTarget),
   ...
   private static void initCelebrateActivity(Brain<Piglin> p_34921_) {
      p_34921_.addActivityAndRemoveMemoryWhenStopped(
         ...
         ImmutableList.of(
            avoidRepellent(),
            SetEntityLookTarget.create(PiglinAi::isPlayerHoldingLovedItem, 14.0F),
            StartAttacking.create((p_449715_, p_449716_) -> p_449716_.isAdult(), PiglinAi::findNearestValidAttackTarget),
         ...
         ImmutableList.of(
            ...
            BehaviorBuilder.sequence(
               ...
               TriggerGate.triggerOneShuffled(
                  ImmutableList.builder().addAll(createLookBehaviors()).add(Pair.of(BehaviorBuilder.triggerIf(p_258950_ -> true), 1)).build()
               )
            ),
   ...
   protected static void maybeRetaliate(ServerLevel p_362623_, AbstractPiglin p_34827_, LivingEntity p_34828_) {
      if (!p_34827_.getBrain().isActive(Activity.AVOID)
         && Sensor.isEntityAttackableIgnoringLineOfSight(p_362623_, p_34827_, p_34828_)
         && !BehaviorUtils.isOtherTargetMuchFurtherAwayThanCurrentAttackTarget(p_34827_, p_34828_, 4.0)) {
   ...
   protected static void broadcastUniversalAnger(ServerLevel p_369015_, AbstractPiglin p_34896_) {
      getAdultPiglins(p_34896_)
         .forEach(p_359293_ -> getNearestVisibleTargetablePlayer(p_359293_).ifPresent(p_359276_ -> setAngerTarget(p_369015_, p_359293_, p_359276_)));
   }
