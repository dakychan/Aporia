...
public class Armadillo extends Animal {
   ...
   protected void readAdditionalSaveData(ValueInput p_408658_) {
      ...
      this.switchToState(p_408658_.<Armadillo.ArmadilloState>read("state", Armadillo.ArmadilloState.CODEC).orElse(Armadillo.ArmadilloState.IDLE));
   ...
   public static enum ArmadilloState implements StringRepresentable {
      ...
      private ArmadilloState(final String p_327882_, final boolean p_330882_, final int p_328662_, final int p_328018_) {
         this.name = p_327882_;
