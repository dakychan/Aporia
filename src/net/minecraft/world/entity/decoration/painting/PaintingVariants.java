   ...
   private static void register(
      ...
      p_458267_.register(
         ...
         new PaintingVariant(
            ...
            Optional.of(Component.translatable(p_455445_.identifier().toLanguageKey("painting", "title")).withStyle(net.minecraft.ChatFormatting.YELLOW)),
            p_452638_
               ? Optional.of(Component.translatable(p_455445_.identifier().toLanguageKey("painting", "author")).withStyle(net.minecraft.ChatFormatting.GRAY))
               : Optional.empty()
         )
      );
   }
