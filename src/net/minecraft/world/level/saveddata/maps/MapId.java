...
public record MapId(int id) implements TooltipProvider {
   ...
   private static final Component LOCKED_TEXT = Component.translatable("filled_map.locked").withStyle(net.minecraft.ChatFormatting.GRAY);
   ...
   public void addToTooltip(Item.TooltipContext p_395024_, Consumer<Component> p_394922_, TooltipFlag p_395978_, DataComponentGetter p_392778_) {
      ...
      if (mapitemsaveddata == null) {
         p_394922_.accept(Component.translatable("filled_map.unknown").withStyle(net.minecraft.ChatFormatting.GRAY));
      } else {
         ...
         if (p_392778_.get(DataComponents.CUSTOM_NAME) == null && mappostprocessing == null) {
            p_394922_.accept(Component.translatable("filled_map.id", this.id).withStyle(net.minecraft.ChatFormatting.GRAY));
         }
         ...
         if (p_395978_.isAdvanced()) {
            ...
            p_394922_.accept(Component.translatable("filled_map.scale", 1 << j).withStyle(net.minecraft.ChatFormatting.GRAY));
            p_394922_.accept(Component.translatable("filled_map.level", j, 4).withStyle(net.minecraft.ChatFormatting.GRAY));
         }
      }
   }
}
