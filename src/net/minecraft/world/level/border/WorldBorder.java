...
public class WorldBorder extends SavedData {
   ...
   public Vec3 clampVec3ToBound(double p_363761_, double p_367247_, double p_362240_) {
      return new Vec3(Mth.clamp(p_363761_, this.getMinX(), this.getMaxX() - 1.0E-5F), p_367247_, Mth.clamp(p_362240_, this.getMinZ(), this.getMaxZ() - 1.0E-5F));
   }
   ...
   class MovingBorderExtent implements WorldBorder.BorderExtent {
      ...
      public double getMinX(float p_451442_) {
         return Mth.clamp(
            WorldBorder.this.getCenterX() - Mth.lerp((double)p_451442_, this.getPreviousSize(), this.getSize()) / 2.0,
      ...
      public double getMinZ(float p_450660_) {
         return Mth.clamp(
            WorldBorder.this.getCenterZ() - Mth.lerp((double)p_450660_, this.getPreviousSize(), this.getSize()) / 2.0,
            (double)(-WorldBorder.this.absoluteMaxSize),
            (double)WorldBorder.this.absoluteMaxSize
         );
      }
      ...
      public double getMaxX(float p_451178_) {
         return Mth.clamp(
            WorldBorder.this.getCenterX() + Mth.lerp((double)p_451178_, this.getPreviousSize(), this.getSize()) / 2.0,
            (double)(-WorldBorder.this.absoluteMaxSize),
            (double)WorldBorder.this.absoluteMaxSize
         );
      }
      ...
      public double getMaxZ(float p_453776_) {
         return Mth.clamp(
            WorldBorder.this.getCenterZ() + Mth.lerp((double)p_453776_, this.getPreviousSize(), this.getSize()) / 2.0,
            (double)(-WorldBorder.this.absoluteMaxSize),
            (double)WorldBorder.this.absoluteMaxSize
         );
      }
