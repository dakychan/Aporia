...
public final class OreVeinifier {
   ...
   protected static NoiseChunk.BlockStateFiller create(
      ...
      BlockState blockstate = net.minecraft.SharedConstants.DEBUG_ORE_VEINS ? Blocks.AIR.defaultBlockState() : null;
      return p_422224_ -> {
            ...
            if (d1 + d2 < 0.4F) {
               ...
               if (randomsource.nextFloat() > 0.7F) {
                  ...
                  if (randomsource.nextFloat() < d3 && p_209670_.compute(p_422224_) > -0.3F) {
                     ...
                     return net.minecraft.SharedConstants.DEBUG_ORE_VEINS ? Blocks.OAK_BUTTON.defaultBlockState() : oreveinifier$veintype.filler;
                  }
               }
            }
         } else {
