...
public record NoiseGeneratorSettings(
   ...
   public boolean isAquifersEnabled() {
      return this.aquifersEnabled && !net.minecraft.SharedConstants.DEBUG_DISABLE_AQUIFERS;
   }

   public boolean oreVeinsEnabled() {
      return this.oreVeinsEnabled && !net.minecraft.SharedConstants.DEBUG_DISABLE_ORE_VEINS;
   }
