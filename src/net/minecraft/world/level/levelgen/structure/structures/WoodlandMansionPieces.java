...
public class WoodlandMansionPieces {
   ...
   static class MansionGrid {
      ...
      private void identifyRooms(WoodlandMansionPieces.SimpleGrid p_230064_, WoodlandMansionPieces.SimpleGrid p_230065_) {
         ...
         while (var20.hasNext()) {
            Tuple<Integer, Integer> tuple = (Tuple<Integer, Integer>)var20.next();
            int k = tuple.getA();
            int l = tuple.getB();
   ...
   static class MansionPiecePlacer {
                  ...
                  if (WoodlandMansionPieces.MansionGrid.isHouse(p_230106_, i1, k) && flag1) {
                     ...
                     if (!WoodlandMansionPieces.MansionGrid.isHouse(p_230106_, i1 + 1, k)) {
                        if (!WoodlandMansionPieces.MansionGrid.isHouse(p_230106_, i1, k - 1)) {
                           ...
                           p_230103_.add(
                              new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "small_wall_corner", blockpos12, p_230105_)
                           );
                        }
      ...
      private void addRoom2x2Secret(
         ...
         p_230098_.add(
            new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, p_230101_.get2x2Secret(this.random), blockpos, p_230100_, Mirror.NONE)
         );
      }
   }
   ...
   public static class WoodlandMansionPiece extends TemplateStructurePiece {
      ...
      public WoodlandMansionPiece(StructureTemplateManager p_230202_, CompoundTag p_230203_) {
         super(
            ...
            p_230203_,
            p_230202_,
            p_452046_ -> makeSettings(
               p_230203_.<Mirror>read("Mi", Mirror.LEGACY_CODEC).orElseThrow(), p_230203_.<Rotation>read("Rot", Rotation.LEGACY_CODEC).orElseThrow()
            )
         );
      }
