...
public class JigsawReplacementProcessor extends StructureProcessor {
   ...
   public StructureTemplate.@Nullable StructureBlockInfo processBlock(
      ...
      if (!blockstate.is(Blocks.JIGSAW) || net.minecraft.SharedConstants.DEBUG_KEEP_JIGSAW_BLOCKS_DURING_STRUCTURE_GEN) {
         return p_74131_;
         ...
         try {
            ...
            LOGGER.error("Failed to parse jigsaw replacement state '{}' at {}: {}", new Object[]{s, p_74128_, var11.getMessage()});
            return null;
         }
