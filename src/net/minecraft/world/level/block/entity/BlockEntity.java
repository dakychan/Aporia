...
public abstract class BlockEntity implements DebugValueSource {
   ...
   public static @Nullable BlockEntity loadStatic(BlockPos p_155242_, BlockState p_155243_, CompoundTag p_155244_, HolderLookup.Provider p_336084_) {
      ...
      if (blockentitytype == null) {
         ...
         try {
            ...
            LOGGER.error("Failed to create block entity {} for block {} at position {} ", new Object[]{blockentitytype, p_155242_, p_155243_, var13});
            return null;
         }
         ...
         try {
            ...
            LOGGER.error("Failed to load data for block entity {} for block {} at position {}", new Object[]{blockentitytype, p_155242_, p_155243_, var12});
            return null;
         }
      }
   }
   ...
   public void fillCrashReportCategory(net.minecraft.CrashReportCategory p_58887_) {
      ...
      if (this.level == null) {
         ...
         net.minecraft.CrashReportCategory.populateBlockLocationDetails(p_58887_, this.level, this.worldPosition);
      }
   }
