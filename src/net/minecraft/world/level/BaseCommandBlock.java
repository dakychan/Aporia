      ...
      if (p_459824_.getGameTime() == this.lastExecution) {
         ...
         if (p_459824_.isCommandBlockEnabled() && !StringUtil.isNullOrEmpty(this.command)) {
            try {
               ...
               net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var7, "Executing command block");
               net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Command to be executed");
