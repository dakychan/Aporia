...
public class LevelSummary implements Comparable<LevelSummary> {
   ...
   public boolean isCompatible() {
      return net.minecraft.SharedConstants.getCurrentVersion().dataVersion().isCompatible(this.levelVersion.minecraftVersion());
   }
   ...
   private Component createInfo() {
      if (this.isLocked()) {
         return Component.translatable("selectWorld.locked").withStyle(net.minecraft.ChatFormatting.RED);
      } else if (this.requiresManualConversion()) {
         return Component.translatable("selectWorld.conversion").withStyle(net.minecraft.ChatFormatting.RED);
      } else if (!this.isCompatible()) {
         return Component.translatable("selectWorld.incompatible.info", this.getWorldVersionName()).withStyle(net.minecraft.ChatFormatting.RED);
      } else {
         ...
         if (this.isExperimental()) {
            mutablecomponent.append(", ").append(Component.translatable("selectWorld.experimental").withStyle(net.minecraft.ChatFormatting.YELLOW));
         }
         ...
         if (this.shouldBackup()) {
            mutablecomponent2.append(mutablecomponent1.withStyle(this.isDowngrade() ? net.minecraft.ChatFormatting.RED : net.minecraft.ChatFormatting.ITALIC));
         } else {
