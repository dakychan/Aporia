...
public interface LevelData {
   ...
   default void fillCrashReportCategory(net.minecraft.CrashReportCategory p_164873_, LevelHeightAccessor p_164874_) {
      p_164873_.setDetail("Level spawn location", () -> net.minecraft.CrashReportCategory.formatLocation(p_164874_, this.getRespawnData().pos()));
