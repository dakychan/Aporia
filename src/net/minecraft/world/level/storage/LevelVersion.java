   ...
   public static LevelVersion parse(Dynamic<?> p_78391_) {
      ...
      return optionaldynamic.result().isPresent()
         ? new LevelVersion(
            i,
            j,
            optionaldynamic.get("Name").asString(net.minecraft.SharedConstants.getCurrentVersion().name()),
            optionaldynamic.get("Id").asInt(net.minecraft.SharedConstants.getCurrentVersion().dataVersion().version()),
            optionaldynamic.get("Series").asString("main"),
            optionaldynamic.get("Snapshot").asBoolean(!net.minecraft.SharedConstants.getCurrentVersion().stable())
         )
