...
public class PrimaryLevelData implements ServerLevelData, WorldData {
   ...
   public static <T> PrimaryLevelData parse(
      ...
      return new PrimaryLevelData(
         (CompoundTag)p_78531_.get("Player").flatMap(CompoundTag.CODEC::parse).result().orElse(null),
         ...
         (UUID)p_78531_.get("WanderingTraderId").read(UUIDUtil.CODEC).result().orElse(null),
   ...
   private void setTagData(RegistryAccess p_78546_, CompoundTag p_78547_, @Nullable CompoundTag p_78548_) {
      ...
      CompoundTag compoundtag = new CompoundTag();
      compoundtag.putString("Name", net.minecraft.SharedConstants.getCurrentVersion().name());
      compoundtag.putInt("Id", net.minecraft.SharedConstants.getCurrentVersion().dataVersion().version());
      compoundtag.putBoolean("Snapshot", !net.minecraft.SharedConstants.getCurrentVersion().stable());
      compoundtag.putString("Series", net.minecraft.SharedConstants.getCurrentVersion().dataVersion().series());
   ...
   @Override
   public void fillCrashReportCategory(net.minecraft.CrashReportCategory p_164972_, LevelHeightAccessor p_164973_) {
