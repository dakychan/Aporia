...
public abstract class ChunkGenerator {
   ...
   public @Nullable Pair<BlockPos, Holder<Structure>> findNearestMapStructure(
      ...
      if (net.minecraft.SharedConstants.DEBUG_DISABLE_FEATURES) {
         return null;
      } else {
   ...
   public void applyBiomeDecoration(WorldGenLevel p_223087_, ChunkAccess p_223088_, StructureManager p_223089_) {
      ...
      if (!net.minecraft.SharedConstants.debugVoidTerrain(chunkpos)) {
         ...
         try {
               ...
               if (p_223089_.shouldGenerateStructures()) {
                  for (Structure structure : map.getOrDefault(k, Collections.emptyList())) {
                     ...
                     try {
                        ...
                        net.minecraft.CrashReport crashreport1 = net.minecraft.CrashReport.forThrowable(var30, "Feature placement");
               ...
               if (k < j) {
                  ...
                  for (int k1 = 0; k1 < j1; k1++) {
                     ...
                     try {
                        ...
                        net.minecraft.CrashReport crashreport2 = net.minecraft.CrashReport.forThrowable(var29, "Feature placement");
                        crashreport2.addCategory("Feature").setDetail("Description", supplier1::get);
                        throw new net.minecraft.ReportedException(crashreport2);
                     }
                  }
               }
            }
            ...
            net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var31, "Biome decoration");
   ...
   public void createStructures(
      ...
      if (!net.minecraft.SharedConstants.DEBUG_DISABLE_STRUCTURES) {
         ...
         for (int k1 = k - 8; k1 <= k + 8; k1++) {
            ...
            for (StructureStart structurestart : p_223077_.getChunk(j1, k1).getAllStarts().values()) {
               try {
                  ...
                  net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var21, "Generating structure reference");
                  net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Structure");
