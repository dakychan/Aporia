...
public class SimpleRegionStorage implements AutoCloseable {
   ...
   public CompoundTag upgradeChunkTag(CompoundTag p_457269_, int p_452563_, @Nullable CompoundTag p_454370_) {
      ...
      if (i == net.minecraft.SharedConstants.getCurrentVersion().dataVersion().version()) {
         return p_457269_;
      } else {
         try {
            ...
            net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var8, "Updated chunk");
            net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Updated chunk details");
