...
public class SmithingTemplateItem extends Item {
   private static final net.minecraft.ChatFormatting TITLE_FORMAT = net.minecraft.ChatFormatting.GRAY;
   private static final net.minecraft.ChatFormatting DESCRIPTION_FORMAT = net.minecraft.ChatFormatting.BLUE;
