...
public class AdventureModePredicate {
   ...
   public static final Component CAN_BREAK_HEADER = Component.translatable("item.canBreak").withStyle(net.minecraft.ChatFormatting.GRAY);
   public static final Component CAN_PLACE_HEADER = Component.translatable("item.canPlace").withStyle(net.minecraft.ChatFormatting.GRAY);
   private static final Component UNKNOWN_USE = Component.translatable("item.canUse.unknown").withStyle(net.minecraft.ChatFormatting.GRAY);
   ...
   private static List<Component> computeTooltip(List<BlockPredicate> p_328947_) {
      ...
      return p_328947_.stream()
         ...
         .distinct()
         .map(p_335858_ -> p_335858_.value().getName().withStyle(net.minecraft.ChatFormatting.DARK_GRAY))
         .toList();
   }
