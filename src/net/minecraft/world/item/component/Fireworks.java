...
public record Fireworks(int flightDuration, List<FireworkExplosion> explosions) implements TooltipProvider {
   ...
   private static void addExplosionTooltip(Consumer<Component> p_395079_, FireworkExplosion p_396802_, int p_392383_) {
      ...
      if (p_392383_ == 1) {
         p_395079_.accept(Component.translatable("item.minecraft.firework_rocket.single_star", component).withStyle(net.minecraft.ChatFormatting.GRAY));
      } else {
         p_395079_.accept(
            Component.translatable("item.minecraft.firework_rocket.multiple_stars", p_392383_, component).withStyle(net.minecraft.ChatFormatting.GRAY)
         );
      }
