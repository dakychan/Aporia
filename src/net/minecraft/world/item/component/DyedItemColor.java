...
public record DyedItemColor(int rgb) implements TooltipProvider {
   ...
   public void addToTooltip(Item.TooltipContext p_332585_, Consumer<Component> p_332053_, TooltipFlag p_329372_, DataComponentGetter p_396680_) {
      if (p_329372_.isAdvanced()) {
         p_332053_.accept(Component.translatable("item.color", String.format(Locale.ROOT, "#%06X", this.rgb)).withStyle(net.minecraft.ChatFormatting.GRAY));
      } else {
         p_332053_.accept(Component.translatable("item.dyed").withStyle(net.minecraft.ChatFormatting.GRAY, net.minecraft.ChatFormatting.ITALIC));
      }
   }
}
