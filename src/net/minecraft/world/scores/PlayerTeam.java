...
public class PlayerTeam extends Team {
   ...
   private net.minecraft.ChatFormatting color = net.minecraft.ChatFormatting.RESET;
   ...
   public PlayerTeam.Packed pack() {
      return new PlayerTeam.Packed(
         ...
         this.color != net.minecraft.ChatFormatting.RESET ? Optional.of(this.color) : Optional.empty(),
   ...
   public void setColor(net.minecraft.ChatFormatting p_83352_) {
      this.color = p_83352_;
      this.scoreboard.onTeamChanged(this);
   }
   ...
   public record Packed(
      ...
      Optional<net.minecraft.ChatFormatting> color,
      ...
      public static final Codec<PlayerTeam.Packed> CODEC = RecordCodecBuilder.create(
         p_391724_ -> p_391724_.group(
               ...
               net.minecraft.ChatFormatting.COLOR_CODEC.optionalFieldOf("TeamColor").forGetter(PlayerTeam.Packed::color),
