...
public class TextComponentTagVisitor implements TagVisitor {
   ...
   private static final net.minecraft.ChatFormatting SYNTAX_HIGHLIGHTING_KEY = net.minecraft.ChatFormatting.AQUA;
   private static final net.minecraft.ChatFormatting SYNTAX_HIGHLIGHTING_STRING = net.minecraft.ChatFormatting.GREEN;
   private static final net.minecraft.ChatFormatting SYNTAX_HIGHLIGHTING_NUMBER = net.minecraft.ChatFormatting.GOLD;
   private static final net.minecraft.ChatFormatting SYNTAX_HIGHLIGHTING_NUMBER_TYPE = net.minecraft.ChatFormatting.RED;
   ...
   private static final Component FOLDED = Component.literal("<...>").withStyle(net.minecraft.ChatFormatting.GRAY);
