...
public class SimpleBitStorage implements BitStorage {
   ...
   public SimpleBitStorage(int p_184724_, int p_184725_, long @Nullable [] p_184726_) {
      Validate.inclusiveBetween(1L, 32L, p_184724_);
      this.size = p_184725_;
      this.bits = p_184724_;
   ...
   public int getAndSet(int p_184731_, int p_184732_) {
      Validate.inclusiveBetween(0L, this.size - 1, p_184731_);
      Validate.inclusiveBetween(0L, this.mask, p_184732_);
   ...
   public void set(int p_184742_, int p_184743_) {
      Validate.inclusiveBetween(0L, this.size - 1, p_184742_);
      Validate.inclusiveBetween(0L, this.mask, p_184743_);
   ...
   public int get(int p_184729_) {
      Validate.inclusiveBetween(0L, this.size - 1, p_184729_);
