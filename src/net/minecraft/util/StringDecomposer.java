   ...
   public static boolean iterateFormatted(String p_14312_, int p_14313_, Style p_14314_, Style p_14315_, FormattedCharSink p_14316_) {
      ...
      for (int j = p_14313_; j < i; j++) {
         ...
         if (c0 == 167) {
            ...
            net.minecraft.ChatFormatting chatformatting = net.minecraft.ChatFormatting.getByCode(c1);
            if (chatformatting != null) {
               style = chatformatting == net.minecraft.ChatFormatting.RESET ? p_14315_ : style.applyLegacyFormat(chatformatting);
            }
