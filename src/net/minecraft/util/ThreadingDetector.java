...
public class ThreadingDetector {
   ...
   public void checkAndUnlock() {
      try {
         ...
         if (thread != null) {
            net.minecraft.ReportedException reportedexception = makeThreadingException(this.name, thread);
   ...
   public static net.minecraft.ReportedException makeThreadingException(String p_199418_, @Nullable Thread p_199419_) {
      ...
      net.minecraft.CrashReport crashreport = new net.minecraft.CrashReport(s1, new IllegalStateException(s1));
      net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Thread dumps");
