...
public class EntityBlockStateFix extends DataFix {
   private static final Map<String, Integer> MAP = (Map<String, Integer>)DataFixUtils.make(Maps.newHashMap(), p_15368_ -> {
   ...
   private Typed<?> updateFallingBlock(Typed<?> p_15336_) {
      ...
      Dynamic<?> dynamic = (Dynamic<?>)p_15336_.get(DSL.remainderFinder());
      return p_15336_.update(
            type.finder(),
            type1,
            p_15355_ -> {
               int i = (Integer)p_15355_.map(
                  p_145262_ -> (Integer)((Either)p_145262_.getSecond()).map(p_145273_ -> p_145273_, EntityBlockStateFix::getBlockId), p_326569_ -> {
   ...
   private Typed<?> updateBlockToBlockState(Typed<?> p_15338_, String p_15339_, String p_15340_, String p_15341_) {
      ...
      Dynamic<?> dynamic = (Dynamic<?>)p_15338_.getOrCreate(DSL.remainderFinder());
      return p_15338_.update(type.finder(), type1, p_15362_ -> {
         int i = (Integer)((Either)p_15362_.getSecond()).map(p_145269_ -> p_145269_, EntityBlockStateFix::getBlockId);
