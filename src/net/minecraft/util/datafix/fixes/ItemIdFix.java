...
public class ItemIdFix extends DataFix {
   ...
   public static String getItem(int p_15943_) {
      return (String)ITEM_NAMES.get(p_15943_);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         p_15947_ -> p_15947_.update(
            opticfinder,
            type1,
            p_145386_ -> (Pair)p_145386_.map(p_145390_ -> Pair.of(References.ITEM_NAME.typeName(), getItem(p_145390_)), p_145388_ -> p_145388_)
         )
      );
   }
}
