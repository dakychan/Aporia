...
public class ItemPotionFix extends DataFix {
   ...
   private static final @Nullable String[] POTIONS = (String[])DataFixUtils.make(new String[128], p_15997_ -> {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         p_15995_ -> {
            ...
            if (optional.isPresent() && Objects.equals(optional.get().getSecond(), "minecraft:potion")) {
               Dynamic<?> dynamic = (Dynamic<?>)p_15995_.get(DSL.remainderFinder());
               ...
               if (optional1.isPresent()) {
                  ...
                  Dynamic<?> dynamic1 = (Dynamic<?>)optional1.get().get(DSL.remainderFinder());
