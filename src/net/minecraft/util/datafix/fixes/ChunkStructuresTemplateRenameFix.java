...
public class ChunkStructuresTemplateRenameFix extends DataFix {
   ...
   private Dynamic<?> fixTag(Dynamic<?> p_15281_, Dynamic<?> p_15282_) {
      ...
      if (RENAMES.containsKey(s)) {
         Pair<String, ImmutableMap<String, String>> pair = (Pair<String, ImmutableMap<String, String>>)RENAMES.get(s);
         if (((String)pair.getFirst()).equals(p_15282_.get("id").asString(""))) {
            String s1 = p_15282_.get("Template").asString("");
            p_15282_ = p_15282_.set("Template", p_15282_.createString((String)((ImmutableMap)pair.getSecond()).getOrDefault(s1, s1)));
         }
      }
