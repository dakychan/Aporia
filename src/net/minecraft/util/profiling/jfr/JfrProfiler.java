   ...
   public boolean start(Environment p_185307_) {
      ...
      if (url == null) {
         ...
         try {
            ...
            LOGGER.warn("Failed to start flight recorder using configuration at {}", url, var9);
            return false;
         }
      }
   }
         ...
         try {
            ...
            this.recording = Util.make(
               ...
               p_405260_ -> {
                  ...
                  p_405260_.setName(
                     String.format(Locale.ROOT, "%s-%s-%s", p_185318_.getDescription(), net.minecraft.SharedConstants.getCurrentVersion().name(), s)
                  );
               }
            );
