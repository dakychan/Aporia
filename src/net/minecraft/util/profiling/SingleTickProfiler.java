...
public class SingleTickProfiler {
   ...
   public static @Nullable SingleTickProfiler createTickProfiler(String p_18633_) {
      return net.minecraft.SharedConstants.DEBUG_MONITOR_TICK_TIMES
         ? new SingleTickProfiler(Util.timeSource, p_18633_, net.minecraft.SharedConstants.MAXIMUM_TICK_TIME_NANOS)
         : null;
   }
