...
public class SystemReport {
   ...
   public SystemReport() {
      this.setDetail("Minecraft Version", net.minecraft.SharedConstants.getCurrentVersion().name());
      this.setDetail("Minecraft Version ID", net.minecraft.SharedConstants.getCurrentVersion().id());
   ...
   public void setDetail(String p_143523_, Supplier<String> p_143524_) {
      try {
         ...
         LOGGER.warn("Failed to get system info for {}", p_143523_, var4);
   ...
   private void ignoreErrors(String p_143517_, Runnable p_143518_) {
      try {
         ...
         LOGGER.warn("Failed retrieving info for group {}", p_143517_, var4);
      }
   }
   ...
   private void putSpaceForPath(String p_344137_, Supplier<@Nullable String> p_344490_) {
      ...
      try {
         ...
         LOGGER.warn("{} is not a path", p_344137_, var6);
         this.setDetail(s, "<invalid path>");
      } catch (Exception var7) {
         LOGGER.warn("Failed retrieving storage space for {}", p_344137_, var7);
