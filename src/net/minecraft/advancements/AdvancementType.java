...
public enum AdvancementType implements StringRepresentable {
   TASK("task", net.minecraft.ChatFormatting.GREEN),
   CHALLENGE("challenge", net.minecraft.ChatFormatting.DARK_PURPLE),
   GOAL("goal", net.minecraft.ChatFormatting.GREEN);

   public static final Codec<AdvancementType> CODEC = StringRepresentable.fromEnum(AdvancementType::values);
   private final String name;
   private final net.minecraft.ChatFormatting chatColor;
   private final Component displayName;

   private AdvancementType(final String p_309637_, final net.minecraft.ChatFormatting p_312188_) {
      this.name = p_309637_;
