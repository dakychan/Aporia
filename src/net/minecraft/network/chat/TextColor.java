...
public final class TextColor {
   ...
   private static final Map<net.minecraft.ChatFormatting, TextColor> LEGACY_FORMAT_TO_COLOR = Stream.of(net.minecraft.ChatFormatting.values())
      .filter(net.minecraft.ChatFormatting::isColor)
   ...
   public static @Nullable TextColor fromLegacyFormat(net.minecraft.ChatFormatting p_131271_) {
