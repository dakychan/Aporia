...
public class ComponentUtils {
   ...
   public static final Component DEFAULT_SEPARATOR = Component.literal(", ").withStyle(net.minecraft.ChatFormatting.GRAY);
   ...
   private static Style resolveStyle(@Nullable CommandSourceStack p_130737_, Style p_130738_, @Nullable Entity p_130739_, int p_130740_) throws CommandSyntaxException {
      if (p_130738_.getHoverEvent() instanceof HoverEvent.ShowText(Component var7)) {
         HoverEvent hoverevent = new HoverEvent.ShowText(updateForEntity(p_130737_, var7, p_130739_, p_130740_ + 1));
   ...
   public static Component formatList(Collection<String> p_130744_) {
      return formatAndSortList(p_130744_, p_130742_ -> Component.literal(p_130742_).withStyle(net.minecraft.ChatFormatting.GREEN));
   }
   ...
   public static MutableComponent copyOnClickText(String p_260039_) {
      return wrapInSquareBrackets(
         Component.literal(p_260039_)
            .withStyle(
               p_389914_ -> p_389914_.withColor(net.minecraft.ChatFormatting.GREEN)
