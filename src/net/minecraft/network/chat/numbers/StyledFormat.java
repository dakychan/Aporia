...
public record StyledFormat(Style style) implements NumberFormat {
   ...
   public static final StyledFormat SIDEBAR_DEFAULT = new StyledFormat(Style.EMPTY.withColor(net.minecraft.ChatFormatting.RED));
   public static final StyledFormat PLAYER_LIST_DEFAULT = new StyledFormat(Style.EMPTY.withColor(net.minecraft.ChatFormatting.YELLOW));
