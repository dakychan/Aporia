...
public final class Style {
   ...
   public Style applyFormat(net.minecraft.ChatFormatting p_131158_) {
   ...
   public Style applyLegacyFormat(net.minecraft.ChatFormatting p_131165_) {
      TextColor textcolor = this.color;
      Boolean obool = this.bold;
      Boolean obool1 = this.italic;
      Boolean obool2 = this.strikethrough;
   ...
   public Style applyFormats(net.minecraft.ChatFormatting... p_131153_) {
      TextColor textcolor = this.color;
      Boolean obool = this.bold;
      Boolean obool1 = this.italic;
      Boolean obool2 = this.strikethrough;
      ...
      for (net.minecraft.ChatFormatting chatformatting : p_131153_) {
