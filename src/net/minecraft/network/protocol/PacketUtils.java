...
public class PacketUtils {
   ...
   public static <T extends PacketListener> net.minecraft.ReportedException makeReportedException(Exception p_331079_, Packet<T> p_335356_, T p_332020_) {
      if (p_331079_ instanceof net.minecraft.ReportedException reportedexception) {
         fillCrashReport(reportedexception.getReport(), p_332020_, p_335356_);
         return reportedexception;
      } else {
         net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(p_331079_, "Main thread packet handler");
         fillCrashReport(crashreport, p_332020_, p_335356_);
         return new net.minecraft.ReportedException(crashreport);
      }
   }

   public static <T extends PacketListener> void fillCrashReport(net.minecraft.CrashReport p_330590_, T p_333816_, @Nullable Packet<T> p_330069_) {
      if (p_330069_ != null) {
         net.minecraft.CrashReportCategory crashreportcategory = p_330590_.addCategory("Incoming Packet");
