...
public class Pack {
   ...
   public static @Nullable Pack readMetaAndCreate(
      ...
      PackFormat packformat = net.minecraft.SharedConstants.getCurrentVersion().packVersion(p_250595_);
   ...
   public static Pack.@Nullable Metadata readPackMetadata(
      ...
      try {
         ...
         LOGGER.warn("Failed to read pack {} metadata", p_330799_.id(), var14);
         return null;
      }
   }
