...
public abstract class ServerCommonPacketListenerImpl implements ServerCommonPacketListener {
   ...
   @Override
   public void onPacketError(Packet p_364882_, Exception p_362532_) throws net.minecraft.ReportedException {
   ...
   public void send(Packet<?> p_300325_, @Nullable ChannelFutureListener p_409441_) {
      ...
      try {
         ...
         net.minecraft.CrashReport crashreport = net.minecraft.CrashReport.forThrowable(var7, "Sending packet");
         net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Packet being sent");
   ...
   public void disconnect(DisconnectionDetails p_345473_) {
      this.connection.send(new ClientboundDisconnectPacket(p_345473_.reason()), PacketSendListener.thenRun(() -> this.connection.disconnect(p_345473_)));
