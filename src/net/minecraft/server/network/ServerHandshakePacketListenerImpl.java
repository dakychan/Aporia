...
public class ServerHandshakePacketListenerImpl implements ServerHandshakePacketListener {
   ...
   private void beginLogin(ClientIntentionPacket p_330592_, boolean p_332714_) {
      this.connection.setupOutboundProtocol(LoginProtocols.CLIENTBOUND);
      if (p_330592_.protocolVersion() != net.minecraft.SharedConstants.getCurrentVersion().protocolVersion()) {
         Component component;
         if (p_330592_.protocolVersion() < 754) {
            component = Component.translatable("multiplayer.disconnect.outdated_client", net.minecraft.SharedConstants.getCurrentVersion().name());
         } else {
            component = Component.translatable("multiplayer.disconnect.incompatible", net.minecraft.SharedConstants.getCurrentVersion().name());
         }
