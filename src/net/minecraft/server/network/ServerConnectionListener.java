               ...
               .childHandler(
                  new ChannelInitializer<Channel>() {
                     protected void initChannel(Channel p_9734_) {
                        ...
                        if (net.minecraft.SharedConstants.DEBUG_FAKE_LATENCY_MS > 0) {
                           channelpipeline.addLast(
                              "latency",
                              new ServerConnectionListener.LatencySimulator(
                                 net.minecraft.SharedConstants.DEBUG_FAKE_LATENCY_MS, net.minecraft.SharedConstants.DEBUG_FAKE_JITTER_MS
                              )
                           );
                        }
               ...
               if (connection.isConnected()) {
                  try {
                     ...
                     if (connection.isMemoryConnection()) {
                        throw new net.minecraft.ReportedException(net.minecraft.CrashReport.forThrowable(var7, "Ticking memory connection"));
                     }
