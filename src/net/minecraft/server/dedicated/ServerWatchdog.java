...
public class ServerWatchdog implements Runnable {
   ...
   public void run() {
      while (this.server.isRunning()) {
         ...
         if (k > this.maxTickTimeNanos) {
            ...
            net.minecraft.CrashReport crashreport = createWatchdogCrashReport("Watching Server", this.server.getRunningThread().threadId());
            this.server.fillSystemReport(crashreport.getSystemReport());
            net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Performance stats");
            ...
            Bootstrap.realStdoutPrintln("Crash report:\n" + crashreport.getFriendlyReport(net.minecraft.ReportType.CRASH));
   ...
   public static net.minecraft.CrashReport createWatchdogCrashReport(String p_362648_, long p_368427_) {
      ...
      net.minecraft.CrashReport crashreport = new net.minecraft.CrashReport(p_362648_, error);
      net.minecraft.CrashReportCategory crashreportcategory = crashreport.addCategory("Thread Dump");
