...
public enum ChatFormatting implements StringRepresentable {
   ...
   public static final Codec<net.minecraft.ChatFormatting> CODEC = StringRepresentable.fromEnum(net.minecraft.ChatFormatting::values);
   public static final Codec<net.minecraft.ChatFormatting> COLOR_CODEC = CODEC.validate(
   ...
   private static final Map<String, net.minecraft.ChatFormatting> FORMATTING_BY_NAME = Arrays.stream(values())
      .collect(Collectors.toMap(p_126660_ -> cleanName(p_126660_.name), p_126652_ -> (net.minecraft.ChatFormatting)p_126652_));
   ...
   private ChatFormatting(final String p_126627_, final char p_126628_, final int p_126629_, final Integer p_126630_) {
   ...
   private ChatFormatting(final @Nullable String p_126640_, final char p_126641_, final boolean p_126642_, final int p_126643_, final Integer p_126644_) {
      this.name = p_126640_;
      this.code = p_126641_;
   ...
   public static @Nullable ChatFormatting getById(int p_126648_) {
      if (p_126648_ < 0) {
         ...
         for (net.minecraft.ChatFormatting chatformatting : values()) {
