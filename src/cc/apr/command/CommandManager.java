...
import cc.apr.command.commands.AliasCommand;
import cc.apr.command.commands.ConfigCommand;
import cc.apr.command.commands.FriendCommand;
import cc.apr.command.commands.InfoCommand;
import cc.apr.command.commands.PrefixCommand;

@Deprecated
/**
 * - Moved to ChatUTILS, unusable? yeah
 */
