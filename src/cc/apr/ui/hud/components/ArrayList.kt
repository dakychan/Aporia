package cc.apr.ui.hud.components
...
class ArrayList(private val textRenderer: MsdfTextRenderer?) : HudComponent("ArrayList") {
    ...
    private val moduleAnimations = mutableMapOf<cc.apr.module.Module, Float>()
    private val modulePositions = mutableMapOf<cc.apr.module.Module, Float>()
    ...
    override fun render(plugin: MinecraftPlugin) {
        ...
        if (maxWidth > 0 && totalHeight > 0) {
            cc.apr.render.RectRenderer.drawRoundedRect(
