...
/**
 * Number (slider/input) setting with min/max bounds.
 */
public class NumberSetting extends Setting<Double> {
    ...
    public NumberSetting(String name, String description, double defaultValue, double min, double max) {
        this(name, description, defaultValue, min, max, 0.1, null);
    }
    ...
    public NumberSetting(String name, String description, double defaultValue, double min, double max, double increment, Supplier<Boolean> visible) {
