...
class WorldRenderer : Module("WorldRenderer", Category.VISUAL) {
    ...
    val time = SliderSetting("Time", "Custom client time (0-24000)", 6000.0, 0.0, 24000.0, 100.0) { customTime.isEnabled }
    val timeSpeed = SliderSetting(
    ...
    override val settings = listOf(customTime, time, timeSpeed, brightness, stars, starDensity, customFog, fogColor, fogStart, fogEnd, fogDensity)
