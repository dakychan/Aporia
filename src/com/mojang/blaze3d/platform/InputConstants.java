...
public class InputConstants {
   ...
   public static InputConstants.Key getKey(KeyEvent p_427399_) {
      return p_427399_.key() == -1 ? InputConstants.Type.SCANCODE.getOrCreate(p_427399_.scancode()) : InputConstants.Type.KEYSYM.getOrCreate(p_427399_.key());
   }
   ...
   public static enum Type {
      ...
      MOUSE(
         "key.mouse",
         (p_84904_, p_84905_) -> Language.getInstance().has(p_84905_)
            ? Component.translatable(p_84905_)
            : Component.translatable("key.mouse", new Object[]{p_84904_ + 1})
      );
