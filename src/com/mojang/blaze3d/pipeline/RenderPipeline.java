...
public class RenderPipeline {
   ...
   public static class Builder {
      ...
      private Optional<net.minecraft.client.renderer.ShaderDefines.Builder> definesBuilder = Optional.empty();
      ...
      public RenderPipeline.Snippet buildSnippet() {
         return new RenderPipeline.Snippet(
            this.vertexShader,
            this.fragmentShader,
            this.definesBuilder.map(net.minecraft.client.renderer.ShaderDefines.Builder::build),
