...
public class RenderSystem {
   ...
   public static void executePendingTasks() {
      for (RenderSystem.GpuAsyncTask rendersystem$gpuasynctask = (RenderSystem.GpuAsyncTask)PENDING_FENCES.peekFirst();
         rendersystem$gpuasynctask != null;
         rendersystem$gpuasynctask = (RenderSystem.GpuAsyncTask)PENDING_FENCES.peekFirst()
      ) {
