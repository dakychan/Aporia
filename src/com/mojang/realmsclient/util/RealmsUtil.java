...
public class RealmsUtil {
   ...
   public static Component convertToAgePresentation(long p_287679_) {
      if (p_287679_ < 0L) {
         ...
         if (i < 60L) {
            return Component.translatable("mco.time.secondsAgo", new Object[]{i});
         } else if (i < 3600L) {
            long l = i / 60L;
            return Component.translatable("mco.time.minutesAgo", new Object[]{l});
         } else if (i < 86400L) {
            long k = i / 3600L;
            return Component.translatable("mco.time.hoursAgo", new Object[]{k});
         } else {
            long j = i / 86400L;
            return Component.translatable("mco.time.daysAgo", new Object[]{j});
         }
      }
   }
   ...
   public static void renderPlayerFace(GuiGraphics p_281255_, int p_281818_, int p_281791_, int p_282088_, UUID p_298294_) {
      RenderInfo playerskinrendercache$renderinfo = Minecraft.getInstance().playerSkinRenderCache().getOrDefault(ResolvableProfile.createUnresolved(p_298294_));
