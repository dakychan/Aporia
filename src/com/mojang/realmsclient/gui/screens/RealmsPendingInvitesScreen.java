...
public class RealmsPendingInvitesScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.pendingInvitationSelectionList = (RealmsPendingInvitesScreen.PendingInvitationSelectionList)this.layout
         .addToContents(new RealmsPendingInvitesScreen.PendingInvitationSelectionList(this.minecraft));
      ...
      this.layout.visitWidgets(p_420602_ -> {
         AbstractWidget abstractwidget = (AbstractWidget)this.addRenderableWidget(p_420602_);
      });
   ...
   class Entry extends net.minecraft.client.gui.components.ContainerObjectSelectionList.Entry<RealmsPendingInvitesScreen.Entry> {
      ...
      Entry(final PendingInvite p_88996_) {
         ...
         this.inviteDate = new StringWidget(
            ...
            .setMaxWidth(i);
         CreateNarration button$createnarration = this.getCreateNarration(p_88996_);
      ...
      private CreateNarration getCreateNarration(PendingInvite p_430008_) {
         return p_447748_ -> {
            MutableComponent mutablecomponent = CommonComponents.joinForNarration(
               new Component[]{
                  (Component)p_447748_.get(),
