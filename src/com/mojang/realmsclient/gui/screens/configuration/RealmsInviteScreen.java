...
public class RealmsInviteScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      LinearLayout linearlayout = (LinearLayout)this.layout.addToContents(LinearLayout.vertical().spacing(8));
      ...
      this.inviteButton = (Button)linearlayout.addChild(Button.builder(TITLE, p_407607_ -> this.onInvite()).width(200).build());
      ...
      this.layout.visitWidgets(p_408136_ -> {
         AbstractWidget abstractwidget = (AbstractWidget)this.addRenderableWidget(p_408136_);
      });
