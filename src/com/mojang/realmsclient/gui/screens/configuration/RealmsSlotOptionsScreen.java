...
public class RealmsSlotOptionsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.nameEdit = (EditBox)this.addWidget(
      ...
      CycleButton<Difficulty> cyclebutton2 = (CycleButton<Difficulty>)this.addRenderableWidget(
      ...
      CycleButton<GameType> cyclebutton = (CycleButton<GameType>)this.addRenderableWidget(
      ...
      CycleButton<Boolean> cyclebutton1 = (CycleButton<Boolean>)this.addRenderableWidget(
      ...
      this.spawnProtectionButton = (RealmsSlotOptionsScreen.SettingsSlider)this.addRenderableWidget(
   ...
   private OnValueChange<Boolean> confirmDangerousOption(Component p_410363_, Consumer<Boolean> p_406359_) {
