...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.downloadButton = (Button)linearlayout.addChild(Button.builder(DOWNLOAD_LATEST, p_409070_ -> this.downloadClicked()).build());
      ...
      this.layout.visitWidgets(p_406978_ -> {
         AbstractWidget abstractwidget = (AbstractWidget)this.addRenderableWidget(p_406978_);
      });
                        ...
                        () -> {
                           ...
                           if (RealmsBackupScreen.this.backupList != null) {
                              RealmsBackupScreen.this.backupList
                                 .replaceEntries(
                                    RealmsBackupScreen.this.backups.stream().map(p_409880_ -> RealmsBackupScreen.this.new Entry(p_409880_)).toList()
                                 );
                           }
                        }
                     );
   ...
   @OnlyIn(Dist.CLIENT)
   class Entry extends net.minecraft.client.gui.components.ContainerObjectSelectionList.Entry<RealmsBackupScreen.Entry> {
      ...
      private void restoreClicked() {
         ...
         String s = RealmsBackupScreen.SHORT_DATE_FORMAT.format(this.backup.lastModifiedDate());
         Component component1 = Component.translatable("mco.configure.world.restore.question.line1", new Object[]{s, component});
         RealmsBackupScreen.this.minecraft
            .setScreen(
