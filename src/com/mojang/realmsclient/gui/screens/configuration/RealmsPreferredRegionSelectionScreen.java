...
public class RealmsPreferredRegionSelectionScreen extends Screen {
   ...
   protected void init() {
      ...
      this.doneButton = (Button)linearlayout1.addChild(Button.builder(CommonComponents.GUI_DONE, p_447760_ -> this.onDone()).build());
      ...
      this.layout.visitWidgets(p_409709_ -> {
         AbstractWidget abstractwidget = (AbstractWidget)this.addRenderableWidget(p_409709_);
      });
   ...
   class RegionSelectionList extends ObjectSelectionList<RealmsPreferredRegionSelectionScreen.RegionSelectionList.Entry> {
      ...
      class Entry extends net.minecraft.client.gui.components.ObjectSelectionList.Entry<RealmsPreferredRegionSelectionScreen.RegionSelectionList.Entry> {
         ...
         public Entry(final RegionSelectionPreference p_409748_, final RealmsRegion p_407499_) {
