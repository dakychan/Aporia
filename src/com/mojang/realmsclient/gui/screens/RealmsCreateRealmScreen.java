...
public class RealmsCreateRealmScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      LinearLayout linearlayout = ((LinearLayout)this.layout.addToContents(LinearLayout.vertical())).spacing(10);
      ...
      LinearLayout linearlayout1 = (LinearLayout)this.layout.addToFooter(LinearLayout.horizontal().spacing(10));
      ...
      this.layout.visitWidgets(p_325125_ -> {
         AbstractWidget abstractwidget = (AbstractWidget)this.addRenderableWidget(p_325125_);
      });
