   ...
   public void init() {
      ...
      if (this.serverAddress.regionData() != null && this.serverAddress.regionData().region() != null) {
         ...
         StringWidget stringwidget = new StringWidget(
            Component.translatable("mco.connect.region", new Object[]{Component.translatable(this.serverAddress.regionData().region().translationKey)}),
            this.font
         );
         ...
         this.footer.visitWidgets(p_409737_ -> {
            AbstractWidget abstractwidget = (AbstractWidget)this.addRenderableWidget(p_409737_);
         });
