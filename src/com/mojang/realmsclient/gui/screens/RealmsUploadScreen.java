...
public class RealmsUploadScreen extends RealmsScreen implements RealmsWorldUploadStatusTracker {
   ...
   public void init() {
      this.backButton = (Button)this.layout.addToFooter(Button.builder(CommonComponents.GUI_BACK, p_90118_ -> this.onBack()).build());
      this.backButton.visible = false;
      this.cancelButton = (Button)this.layout.addToFooter(Button.builder(CommonComponents.GUI_CANCEL, p_90104_ -> this.onCancel()).build());
      ...
      this.layout.visitWidgets(p_325163_ -> {
         AbstractWidget abstractwidget = (AbstractWidget)this.addRenderableWidget(p_325163_);
      });
   ...
   private void drawProgressBar(GuiGraphics p_282575_) {
      ...
      p_282575_.drawCenteredString(this.font, Component.translatable("mco.upload.percent", new Object[]{this.progress}), this.width / 2, 84, -1);
   }
         ...
         realmsworldupload.packAndUpload().handleAsync((p_357567_, p_357568_) -> {
            if (p_357568_ != null) {
               ...
               if (p_357568_ instanceof RealmsUploadException realmsuploadexception) {
                  ...
                  this.status = Component.translatable("mco.upload.failed", new Object[]{p_357568_.getMessage()});
               }
            } else {
