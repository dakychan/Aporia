...
public interface RealmsError {
   ...
   public record CustomError(int httpCode, @Nullable Component payload) implements RealmsError {
      ...
      public static RealmsError.CustomError unknownCompatibilityResponse(String p_300024_) {
         return new RealmsError.CustomError(500, Component.translatable("mco.errorMessage.realmsService.unknownCompatibility", new Object[]{p_300024_}));
      }
      ...
      public static RealmsError.CustomError connectivityError(RealmsHttpException p_298467_) {
         return new RealmsError.CustomError(500, Component.translatable("mco.errorMessage.realmsService.connectivity", new Object[]{p_298467_.getMessage()}));
      }
