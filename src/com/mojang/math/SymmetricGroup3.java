...
public enum SymmetricGroup3 {
   ...
   public net.minecraft.core.Direction.Axis permuteAxis(net.minecraft.core.Direction.Axis p_456324_) {
      return net.minecraft.core.Direction.Axis.VALUES[this.permute(p_456324_.ordinal())];
   }
