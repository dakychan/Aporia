...
public enum OctahedralGroup implements StringRepresentable {
      ...
      () -> {
         ...
         for (OctahedralGroup octahedralgroup : aoctahedralgroup) {
            for (OctahedralGroup octahedralgroup1 : aoctahedralgroup) {
               ...
               boolean flag = octahedralgroup.inverts(net.minecraft.core.Direction.Axis.X)
                  ^ octahedralgroup1.inverts(octahedralgroup.permutation.permuteAxis(net.minecraft.core.Direction.Axis.X));
               boolean flag1 = octahedralgroup.inverts(net.minecraft.core.Direction.Axis.Y)
                  ^ octahedralgroup1.inverts(octahedralgroup.permutation.permuteAxis(net.minecraft.core.Direction.Axis.Y));
               boolean flag2 = octahedralgroup.inverts(net.minecraft.core.Direction.Axis.Z)
                  ^ octahedralgroup1.inverts(octahedralgroup.permutation.permuteAxis(net.minecraft.core.Direction.Axis.Z));
   ...
   public Direction rotate(Direction p_56529_) {
      if (this.rotatedDirections == null) {
         this.rotatedDirections = Util.makeEnumMap(Direction.class, p_447715_ -> {
            net.minecraft.core.Direction.Axis direction$axis = p_447715_.getAxis();
            AxisDirection direction$axisdirection = p_447715_.getAxisDirection();
            net.minecraft.core.Direction.Axis direction$axis1 = this.permutation.inverse().permuteAxis(direction$axis);
            AxisDirection direction$axisdirection1 = this.inverts(direction$axis1) ? direction$axisdirection.opposite() : direction$axisdirection;
   ...
   public boolean inverts(net.minecraft.core.Direction.Axis p_56527_) {
